...
if (!empty($error)) {
    ...
    if (!empty($exception)) {
        echo '<p>Original message: '.$exception->getMessage().'</p>';
            ...
            <p><a href="http://docs.novius-os.org/en/dubrovka/install/whats_next/first_page.html" target="_blank">Check out our guide</a> to get started.</p>
            ...
            <p><a href="http://docs.novius-os.org/en/dubrovka/app_create/index.html" target="_blank">Have a look at the documentation</a>.</p>
