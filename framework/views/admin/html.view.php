...
$config = array(
    ...
    'shim' => array(
        ...
        'wijmo.wijcheckbox' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'wijmo.widget'),
        ...
        'wijmo.wijdropdown' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.resizable', 'jquery-ui.draggable', 'jquery-ui.effects.core', 'jquery.mousewheel', 'wijmo.widget', 'wijmo.wijsuperpanel'),
        ...
        'wijmo.wijradio' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'wijmo.widget'),
        ...
        'wijmo.wijtextbox' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'wijmo.widget'),
...
if (!$assets_minified) {
    $config['paths'] = array_merge($config['paths'], array(
        ...
        'wijmo.wijcheckbox' => 'static/novius-os/admin/vendor/wijmo/js/wijcheckbox/jquery.wijmo.wijcheckbox',
        ...
        'wijmo.wijdropdown' => 'static/novius-os/admin/vendor/wijmo/js/wijdropdown/jquery.wijmo.wijdropdown',
        ...
        'wijmo.wijradio' => 'static/novius-os/admin/vendor/wijmo/js/wijradio/jquery.wijmo.wijradio',
        ...
        'wijmo.wijtextbox' => 'static/novius-os/admin/vendor/wijmo/js/wijtextbox/jquery.wijmo.wijtextbox',
...
<link rel="stylesheet" href="static/novius-os/admin/vendor/wijmo/css/jquery.wijmo-pro.all.3.20131.3.min.css">
<?php
if ($assets_minified) {
    ?>
