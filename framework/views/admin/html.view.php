...
$config = array(
    ...
    'paths' => array(
        ...
        'jquery' => 'static/novius-os/admin/vendor/jquery/jquery-1.10.2.min',
        ...
        'jquery-ui.datetimepicker' =>
            'static/novius-os/admin/vendor/jquery/ui-datetimepicker/jquery-ui-timepicker-addon.min',
        'jquery-ui.datetimepicker.i18n' =>
            'static/novius-os/admin/vendor/jquery/ui-datetimepicker/i18n/jquery-ui-i18n.min',
        ...
        'jquery-ui.effects.highlight' =>
            'static/novius-os/admin/vendor/jquery-ui/minified/jquery.ui.effects.ts.highlight.min',
        ...
        'wijmo.wijbubblechart' =>
            'static/novius-os/admin/vendor/wijmo/js/wijbubblechart/jquery.wijmo.wijbubblechart.min',
        ...
        'wijmo.wijcompositechart' =>
            'static/novius-os/admin/vendor/wijmo/js/wijcompositechart/jquery.wijmo.wijcompositechart.min',
        ...
        'wijmo.wijprogressbar' =>
            'static/novius-os/admin/vendor/wijmo/js/wijprogressbar/jquery.wijmo.wijprogressbar.min',
        'wijmo.wijradialgauge' =>
            'static/novius-os/admin/vendor/wijmo/js/wijradialgauge/jquery.wijmo.wijradialgauge.min',
        ...
        'wijmo.wijscatterchart' =>
            'static/novius-os/admin/vendor/wijmo/js/wijscatterchart/jquery.wijmo.wijscatterchart.min',
        ...
        'jquery-nos-update-tab-crud' =>
            'static/novius-os/admin/novius-os/js/views/minified/jquery.novius-os.update-tab-crud',
        ...
        'jquery-nos-media-folder-form' =>
            'static/novius-os/admin/novius-os/js/media/minified/jquery.novius-os.media-folder-form',
        'jquery-nos-media-add-form' =>
            'static/novius-os/admin/novius-os/js/media/minified/jquery.novius-os.media-add-form',
        'jquery-nos-media-edit-form' =>
            'static/novius-os/admin/novius-os/js/media/minified/jquery.novius-os.media-edit-form',
        'jquery-nos-image-wysiwyg' =>
            'static/novius-os/admin/novius-os/js/media/minified/jquery.novius-os.image-wysiwyg',
        ...
        'jquery-nos-inspector-date' =>
            'static/novius-os/admin/novius-os/js/inspector/minified/jquery.novius-os.inspector-date',
        'jquery-nos-inspector-model' =>
            'static/novius-os/admin/novius-os/js/inspector/minified/jquery.novius-os.inspector-model',
        'jquery-nos-inspector-tree-model' =>
            'static/novius-os/admin/novius-os/js/inspector/minified/jquery.novius-os.inspector-tree-model',
        'jquery-nos-inspector-tree-model-checkbox' =>
            'static/novius-os/admin/novius-os/js/inspector/minified/jquery.novius-os.inspector-tree-model-checkbox',
        'jquery-nos-inspector-tree-model-radio' =>
            'static/novius-os/admin/novius-os/js/inspector/minified/jquery.novius-os.inspector-tree-model-radio',
    ...
    'shim' => array(
        ...
        'jquery-ui.datetimepicker' => array('jquery', 'jquery-ui.datepicker', 'jquery-ui.slider',
        ...
        'jquery.passwordstrength' => array('jquery',
        ...
        'jquery-ui.droppable' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.mouse',
            'jquery-ui.draggable'),
        ...
        'jquery-ui.dialog' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.mouse',
            'jquery-ui.position'),
        ...
        'wijmo.wijbarchart' => array('jquery', 'jquery-ui.widget', 'wijmo.widget', 'wijmo.raphael', 'jquery.globalize',
            'jquery.globalize.cultures', 'wijmo.wijchartcore'),
        'wijmo.wijbubblechart' => array('jquery', 'jquery-ui.widget', 'wijmo.widget', 'wijmo.raphael',
            'jquery.globalize', 'jquery.globalize.cultures', 'wijmo.wijchartcore'),
        'wijmo.wijcalendar' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'wijmo.widget', 'wijmo.wijutil',
            'wijmo.wijpopup', 'jquery.globalize', 'jquery.globalize.cultures', 'jquery-ui.effects.core',
            'jquery-ui.effects.blind', 'jquery-ui.effects.slide', 'jquery-ui.effects.scale'),
        ...
        'wijmo.wijcombobox' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.position',
            'wijmo.widget', 'wijmo.wijlist'),
        'wijmo.wijcompositechart' => array('jquery', 'jquery-ui.widget', 'wijmo.widget', 'wijmo.raphael',
            'jquery.globalize', 'jquery.globalize.cultures', 'wijmo.wijchartcore'),
        'wijmo.wijdatasource' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget'),
        'wijmo.wijdatepager' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery.globalize',
            'jquery.globalize.cultures', 'wijmo.widget', 'wijmo.wijutil', 'wijmo.wijpopup'),
        'wijmo.wijdialog' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.dialog', 'wijmo.widget',
            'wijmo.wijutil', 'jquery-ui.effects.core', 'jquery-ui.effects.blind', 'jquery-ui.effects.slide',
            'jquery-ui.effects.scale', 'jquery-ui.effects.transfer', 'jquery-ui.effects.fade'),
        'wijmo.wijdropdown' => array('jquery-nos'),
        'wijmo.wijeditor' => array('jquery', 'jquery-ui.core', 'jquery-ui.mouse', 'jquery-ui.widget', 'jquery-ui.tabs',
            'jquery-ui.position', 'jquery-ui.draggable', 'wijmo.widget', 'wijmo.wijutil', 'wijmo.wijspliter',
            'wijmo.wijdialog', 'wijmo.wijmenu', 'wijmo.wijtabs'),
        ...
        'wijmo.wijgrid' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.draggable',
            'jquery-ui.droppable', 'wijmo.widget', 'wijmo.wijinputdate', 'wijmo.wijinputtext', 'wijmo.wijinputnumber',
            'wijmo.wijutil', 'wijmo.data.wijdatasource', 'wijmo.wijdatasource', 'jquery.globalize',
            'jquery.globalize.cultures'),
        ...
        'wijmo.wijlineargauge' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery.globalize',
            'jquery.globalize.cultures', 'wijmo.widget', 'wijmo.raphael', 'wijmo.wijgauge'),
        'wijmo.wijlinechart' => array('jquery', 'jquery-ui.widget', 'jquery.globalize', 'jquery.globalize.cultures',
            'wijmo.widget', 'wijmo.raphael', 'wijmo.wijchartcore'),
        'wijmo.wijlist' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'wijmo.widget',
            'wijmo.wijutil', 'wijmo.wijsuperpanel'),
        'wijmo.wijmenu' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'wijmo.widget', 'wijmo.wijutil',
            'jquery-ui.position', 'jquery-ui.effects.core', 'jquery.mousewheel', 'wijmo.wijsuperpanel'),
        'wijmo.wijpager' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'wijmo.widget'),
        'wijmo.wijpiechart' => array('jquery', 'jquery-ui.widget', 'jquery.globalize', 'jquery.globalize.cultures',
            'wijmo.widget', 'wijmo.raphael', 'wijmo.wijchartcore'),
        'wijmo.wijpopup' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.position', 'wijmo.widget',
            'wijmo.wijutil'),
        'wijmo.wijprogressbar' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'wijmo.widget',
            'jquery-ui.progressbar'),
        'wijmo.wijradialgauge' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery.globalize',
            'jquery.globalize.cultures', 'wijmo.widget', 'wijmo.raphael', 'wijmo.wijgauge'),
        ...
        'wijmo.wijscatterchart' => array('jquery', 'jquery-ui.widget', 'jquery.globalize', 'jquery.globalize.cultures',
            'wijmo.widget', 'wijmo.raphael', 'wijmo.wijchartcore'),
        'wijmo.wijslider' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.slider',
            'jquery-ui.effects.core', 'wijmo.widget', 'wijmo.wijutil'),
        'wijmo.wijsplitter' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.resizable',
            'jquery-ui.mouse', 'wijmo.widget', 'wijmo.wijutil'),
        'wijmo.wijsuperpanel' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.resizable',
            'jquery-ui.draggable', 'jquery-ui.effects.core', 'jquery.mousewheel', 'wijmo.widget'),
        'wijmo.wijtabs' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.position',
            'jquery-ui.effects.core', 'jquery.cookie', 'wijmo.widget', 'wijmo.wijsuperpanel'),
        'wijmo.wijtextbox' => array('jquery-nos'),
        'wijmo.wijtooltip' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.position',
            'wijmo.widget'),
        'wijmo.wijtree' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.draggable',
            'jquery-ui.droppable', 'jquery-ui.effects.core', 'wijmo.widget', 'wijmo.wijutil', 'wijmo.wijtextbox'),
        ...
        'wijmo.wijwizard' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget','jquery-ui.position',
            'jquery-ui.effects.core', 'jquery.cookie', 'wijmo.widget', 'wijmo.wijutil', 'wijmo.wijsuperpanel'),
    ),
...
if (!$assets_minified) {
    ...
    $config['paths'] = array_merge($config['paths'], array(
        ...
        'wijmo.wijcheckbox' => 'static/novius-os/admin/novius-os/js/jquery.novius-os',
        'wijmo.wijcombobox' => 'static/novius-os/admin/vendor/wijmo/js/wijcombobox/jquery.wijmo.wijcombobox',
        'wijmo.wijcompositechart' =>
            'static/novius-os/admin/vendor/wijmo/js/wijcompositechart/jquery.wijmo.wijcompositechart',
        ...
        'wijmo.wijdropdown' => 'static/novius-os/admin/novius-os/js/jquery.novius-os',
        ...
        'wijmo.wijinputmaskcore' => 'static/novius-os/admin/vendor/wijmo/js/wijinput/jquery.wijmo.wijinputmask',
        ...
        'wijmo.wijradio' => 'static/novius-os/admin/novius-os/js/jquery.novius-os',
        ...
        'wijmo.wijscatterchart' =>
            'static/novius-os/admin/vendor/wijmo/js/wijscatterchart/jquery.wijmo.wijscatterchart',
        ...
        'wijmo.wijtextbox' => 'static/novius-os/admin/novius-os/js/jquery.novius-os',
        ...
        'jquery-nos-media-folder-form' =>
            'static/novius-os/admin/novius-os/js/media/jquery.novius-os.media-folder-form',
