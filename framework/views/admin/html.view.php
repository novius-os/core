...
$config = array(
    ...
    'shim' => array(
        ...
        'wijmo.wijdropdown' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'jquery-ui.resizable', 'jquery-ui.draggable', 'jquery-ui.effects.core', 'jquery.mousewheel', 'wijmo.wijsuperpanel'),
        ...
        'wijmo.wijmenu' => array('jquery', 'jquery-ui.core', 'jquery-ui.widget', 'wijmo.wijutil', 'jquery-ui.position', 'jquery-ui.effects.core', 'jquery.mousewheel', 'wijmo.wijsuperpanel'),
...
<link rel="stylesheet" href="static/novius-os/admin/vendor/wijmo/css/jquery.wijmo-complete.all.2.3.7.min.css">
<?php
if ($assets_minified) {
    ?>
