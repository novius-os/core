...
class Orm_Behaviour_Publishable extends Orm_Behaviour
{
    ...
    public static function publication_status($item)
    {
        ...
        if ($published === true) {
            return '<img class="publication_status" src="static/novius-os/admin/novius-os/img/icons/status-green.png"> '.___('nos::admin/global', 'Published');
        }
        if ($published === false) {
            return '<img class="publication_status" src="static/novius-os/admin/novius-os/img/icons/status-red.png"> '.___('nos::admin/global', 'Not published');
        }

        return '<img class="publication_status" src="static/novius-os/admin/novius-os/img/icons/status-schedule.png"> '.strtr(___('nos::admin/global', 'From {date}'), array(
