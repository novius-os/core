...
class Model_Page extends \Nos\Orm\Model
{
    ...
    protected static $_behaviours = array(
        'Nos\Orm_Behaviour_Translatable' => array(
            ...
            'site_property'      => 'page_site',
            'common_id_property' => 'page_site_common_id',
            'is_main_property' => 'page_site_is_main',
            'invariant_fields'   => array(
                //'page_parent_id', // Depends on the site, cannot be updated automagically
                //'page_template',
                'page_level',
                //'page_raw_html',
                'page_sort',
    ...
    public function get_href($params = array())
    {
        if ($this->page_type == self::TYPE_EXTERNAL_LINK) {
            ...
            if (empty($page_external_link) && !$this->is_main_site()) {
                $page_external_link = $this->find_main_site()->page_external_link;
            }
