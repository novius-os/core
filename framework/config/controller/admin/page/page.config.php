...
return array(
    ...
    'messages' => array(
        ...
        'exists in multiple site' => __('This page exists in <strong>{count} sites</strong>.'),
        'delete in the following sites' => __('Delete this page in the following sites:'),
        ...
        'error added in site not parent' => __('This page cannot be added {site} because its {parent} is not available in this site yet.'),
        'error added in site' => __('This page cannot be added {site}.'),
        'item inexistent in site yet' => __('This page has not been added in {site} yet.'),
        'add an item in site' => __('Add a new page in {site}'),
