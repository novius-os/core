...
// 0 out of 324 words are translated (0%).

return array(
	#: classes/controller/admin/media/media.ctrl.php:52
	'Change the file:' => '',

	#: classes/controller/admin/media/media.ctrl.php:66
	'This extension is not allowed due to security reasons.' => '',

	#: classes/controller/admin/media/media.ctrl.php:90
	'Please pick a file from your hard drive.' => '',

	#: classes/controller/admin/media/media.ctrl.php:94
	#: classes/controller/admin/media/media.ctrl.php:110
	'A file with the same name already exists.' => '',

	#: classes/controller/admin/media/media.ctrl.php:105
	#: classes/controller/admin/media/media.ctrl.php:124
	#: classes/controller/admin/media/media.ctrl.php:136
	'No write permission. This is not your fault, but rather a misconfiguration from the server admin. Tell her/him off!' => '',

	#: views/admin/media/media_delete.view.php:18
	'The media is not used anywhere and can be safely deleted.' => '',

	#: views/admin/media/media_delete.view.php:19
	#: views/admin/media/folder_delete.view.php:19
	'Please confirm the suppression below.' => '',

	#: views/admin/media/media_delete.view.php:24
	'The media is used <strong>one time</strong> by your applications.' => '',

	#: views/admin/media/media_delete.view.php:29
	#: views/admin/media/folder_delete.view.php:29
	'To confirm the deletion, you need to enter this number in the field below' => '',

	#: views/admin/media/media_delete.view.php:30
	'Yes, I want to delete all {count} usage of the media.' => '',

	#: views/admin/media/wysiwyg_image.view.php:26
	'Pick a new image' => '',

	#: views/admin/media/wysiwyg_image.view.php:26
	'1. Pick your image' => '',

	#: views/admin/media/wysiwyg_image.view.php:27
	'Edit properties' => '',

	#: views/admin/media/wysiwyg_image.view.php:27
	'2. Set the properties' => '',

	#: views/admin/media/wysiwyg_image.view.php:36
	'Title:' => '',

	#: views/admin/media/wysiwyg_image.view.php:40
	'Description:' => '',

	#: views/admin/media/wysiwyg_image.view.php:41
	'Use {field}' => '',

	#: views/admin/media/wysiwyg_image.view.php:41
	'title' => '',

	#: views/admin/media/wysiwyg_image.view.php:44
	'Width:' => '',

	#: views/admin/media/wysiwyg_image.view.php:45
	'Keep proportions' => '',

	#: views/admin/media/wysiwyg_image.view.php:48
	'Height:' => '',

	#: views/admin/media/wysiwyg_image.view.php:52
	'Style:' => '',
	...
	#: views/admin/media/media_edit.view.php:41
	#: views/admin/media/media_add.view.php:31
	#: views/admin/media/folder.view.php:42
	'Generate from title' => '',

	#: views/admin/media/folder_delete.view.php:18
	'The folder is empty and can be safely deleted.' => '',

	#: views/admin/media/folder_delete.view.php:24
