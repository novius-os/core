...
return array(
	...
	#: views/admin/user/permission.view.php:25
	'Full access for everything' => '',

	#: views/admin/user/permission.view.php:47
	'Application provided by {provider_name}' => '',

	#: views/admin/user/user_edit.view.php:39
	'User details' => '',

	#: views/admin/user/user_edit.view.php:40
	...
	'Deleting a user is permanent, there is no undo.' => '',
