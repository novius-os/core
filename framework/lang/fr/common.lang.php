...
// 153 out of 155 messages are translated (98%).
// 833 out of 838 words are translated (98%).
...
return array(
    ...
    '<row><cell>Will be published since:</cell><cell>{{start}}</cell><cell>{{clear}}</cell></row><row><cell>until:</cell><cell>{{end}}</cell><cell>{{clear}}</cell></row>' => '<row><cell>Sera publié du&nbsp;:</cell><cell>{{start}}</cell><cell>{{clear}}</cell></row><row><cell>jusqu\'au&nbsp;:</cell><cell>{{end}}</cell><cell>{{clear}}</cell></row>',
    ...
    #: views/form/layout_standard.view.php:78
