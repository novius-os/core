...
return array(
    ...
    'Done, your password has been changed.' => 'Vi, tu passe-parol ha esset changeat.',

    #: classes/controller/admin/account.ctrl.php:84
    'Your Novius OS has switched to {{language}}. Okay, not quite. Actually it needs a <a>quick refresh</a>.' => 'Tu Novius OS es nu in {{language}}. OK, quasi... Tu solmen deve <a>actualisar</a>.',

    #: classes/controller/admin/account.ctrl.php:87
    'Sorry but your Novius OS doesn’t speak {{code}}.' => 'Trist ma tu Novius OS ne parla  {{code}}.',

    #: classes/controller/admin/account.ctrl.php:97
    'Wallpaper' => 'Scren-image',

    #: classes/controller/admin/account.ctrl.php:121
    '‘{{title}}’ is your new gorgeous wallpaper. Go quick to the home tab to see it.' => '‘{{title}}’ es tu nov magnific scren-image. Go rapidmen al pagine principal por vider it.',

    #: classes/controller/admin/account.ctrl.php:129
    'This is unexpected: The selected image doesn’t exist any more. It must have been deleted while you were selecting it.' => 'To es inexpectet: li selectet image ne plu existe. It certmen ha esset deletet durante que tu selectat it. ',
    ...
    'OK, permissions saved.' => 'OK, permissions preservat.',
    ...
    'Set a new password' => 'Changear li passa-parol',

    #: views/admin/password_strength.view.php:14
    'Insufficient' => 'insuficent',
    ...
    'New user added. We look forward to see her/him soon.' => 'Nov usator addit. Saluta li!',

    #: config/common/user.config.php:33
    'The user has been deleted.' => 'Li usator ha esset deletet.',

    #. General errors
    #: config/common/user.config.php:36
    'This user doesn’t exist any more. It has been deleted.' => 'Ti usator ne plu existe. It ha esset deletet.',

    #: config/common/user.config.php:37
    'We cannot find this user.' => 'Noi ne posse truvar ti usator.',
    ...
    'All wrapped up! This new role is ready.' => 'Vi, li nov rol es usabil.',

    #: config/common/role.config.php:20
    'The role has been deleted.' => 'Li rol ha esset deletet.',

    #. General errors
    #: config/common/role.config.php:23
    'This role doesn’t exist any more. It has been deleted.' => 'Ti rol ne plu existe. It ha esset deletet.',

    #: config/common/role.config.php:24
    'We cannot find this role.' => 'Noi ne posse truval ti rol.',
