...
return array(
    ...
    'Last signed in on:' => '前回ログインした日時:',

    #: config/controller/admin/user.config.php:66
    'Expert view' => 'エキスパート表示',
    ...
    'New user added. We look forward to see her/him soon.' => '新しいユーザーが追加されました。参加をお待ちしています。',

    #: config/common/user.config.php:33
    'The user has been deleted.' => 'ユーザーが削除されました。',

    #. General errors
    #: config/common/user.config.php:36
    'This user doesn’t exist any more. It has been deleted.' => 'このユーザーは存在しません。削除されました。',

    #: config/common/user.config.php:37
    'We cannot find this user.' => 'このユーザーは見つかりませんでした。',
