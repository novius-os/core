...
// 47 out of 47 messages are translated (100%).
// 208 out of 208 words are translated (100%).
...
return array(
    ...
    #: classes/controller/admin/account.ctrl.php:83
    ...
    #: classes/controller/admin/account.ctrl.php:86
    'Sorry but your Novius OS doesn’t speak {{code}}.' => 'Désolés mais votre Novius OS ne parle pas {{code}}.',

    #: classes/controller/admin/account.ctrl.php:96
    'Wallpaper' => 'Fond d’écran',

    #: classes/controller/admin/account.ctrl.php:120
    ...
    #: classes/controller/admin/account.ctrl.php:128
    ...
    #: classes/controller/admin/account.ctrl.php:139
    ...
    #: views/admin/account.view.php:93
    #: views/admin/user_add.view.php:70
    'Strong' => 'Fort',

    #: views/admin/user_edit.view.php:94
    #: views/admin/account.view.php:94
    #: views/admin/user_add.view.php:71
