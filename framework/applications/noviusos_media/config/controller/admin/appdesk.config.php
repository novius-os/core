...
return array(
    ...
    'appdesk' => array(
        'actions' => array(
            'edit' => array(
                ...
                'action' => array(
                    'action' => 'nosTabs',
                    'tab' => array(
                        'url' => 'admin/noviusos_media/media/insert_update/{{id}}',
            ...
            'delete' => array(
                ...
                'action' => array(
                    ...
                    'dialog' => array(
                        'contentUrl' => 'admin/noviusos_media/media/delete/{{id}}',
        ...
        'tab' => array(
            ...
            'iconUrl' => 'static/apps/noviusos_media/img/media-32.png',
        ),
        'reloadEvent' => array(
        ...
        'appdesk' => array(
            ...
            'buttons' => array(
                'media' => array(
                    ...
                    'action' => array(
                        ...
                        'method' => 'add',
                        'tab' => array(
                            'url' => 'admin/noviusos_media/media/insert_update',
                            'label' => __('Add a media'),
                        ),
                    ),
                ),
                'folder' => array(
                    ...
                    'action' => array(
                        ...
                        'method' => 'add',
                        'tab' => array(
                            'url' => 'admin/noviusos_media/folder/insert_update',
                            'label' => 'Add a folder',
                        ),
                        'dialog' => array(
                            'width' => 600,
            ...
            'grid' => array(
                'id' => 'nos_media_grid',
                'urlJson' => 'admin/noviusos_media/appdesk/json',
                'columns' => array(
                    'extension' => array(
                        'headerText' => __('Ext.'),
                        'dataKey' => 'extension',
            ...
            'inspectors' => array(
                'folders' => array(
                    'vertical' => true,
                    'label' => __('Folders'),
                    'url' => 'admin/noviusos_media/inspector/folder/list',
                    'inputName' => 'folder_id',
                                ...
                                'actions' => array(
                                    ...
                                    array(
                                        ...
                                        'action' => array(
                                            'action' => 'nosTabs',
                                            'tab' => array(
                                                'url' => 'admin/noviusos_media/folder/insert_update/{{id}}',
                                    ...
                                    array(
                                        ...
                                        'action' => array(
                                            'action' => 'confirmationDialog',
                                            'dialog' => array(
                                                'contentUrl' => 'admin/noviusos_media/folder/delete/{{id}}',
