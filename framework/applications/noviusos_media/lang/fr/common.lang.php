...
// 121 out of 121 messages are translated (100%).
// 658 out of 658 words are translated (100%).
...
return array(
    ...
    'Archives (e.g. ZIP)' => 'Archives (ex&nbsp;: ZIP)',
    ...
    #: config/common/media.config.php:125
    ...
    'Select a folder where to put your media file:' => 'Sélectionner un dossier où ranger votre média&nbsp;:',
    ...
    'Spot on! One more media file in your Centre.' => 'Nickel&nbsp;! Un nouveau fichier dans votre médiathèque.',

    #: config/common/media.config.php:32
    'The media file has been deleted.' => 'Le média a été supprimé.',

    #. General errors
    #: config/common/media.config.php:35
    'This media file doesn’t exist any more. It has been deleted.' => 'Ce média n’existe plus. Il a été supprimé.',

    #: config/common/media.config.php:36
    'We cannot find this media file.' => 'Nous n’arrivons pas à trouver ce média.',
    ...
    #: config/common/media.config.php:87
    'Path' => 'Chemin',

    #: config/common/media.config.php:141
    ...
    'The folder has been deleted.' => 'Le dossier a été supprimé.',

    #. General errors
    #: config/common/folder.config.php:31
    'This folder doesn’t exist any more. It has been deleted.' => 'Ce dossier n’existe plus. Il a été supprimé.',

    #: config/common/folder.config.php:32
    'We cannot find this folder.' => 'Nous n’arrivons pas à trouver ce dossier.',
    ...
    #: views/admin/folder.view.php:45
    ...
    #: views/admin/wysiwyg_image.view.php:29
    '1. Pick an image' => '1. Sélectionner une image',
    ...
    'Keep proportions' => 'Conserver les proportions',
    ...
    'We’re afraid you’re not allowed to upload files this big. Don’t blame Novius OS though, your developer or system administrator are the ones who make the rules.' => 'Nous avons peur de ne pas être autorisé à télécharger des fichiers aussi gros. Cependant, ne blâmez pas Novius OS, votre développeur ou administrateur système sont ceux qui font les règles.',
    ...
    #: classes/model/folder.model.php:251
    ...
    'One file was already present!' => array(
