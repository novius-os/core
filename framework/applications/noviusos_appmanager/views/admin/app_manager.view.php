...
foreach ($installed as $app) {
    ...
    ?>
                    <tr>
                        <td>&nbsp;<img src="<?= isset($metadata['icons'][16]) ? $metadata['icons'][16] : 'static/novius-os/admin/novius-os/img/16/application.png' ?>" width="16" style="vertical-align:top;" alt="" title="" /> <?= e($app->get_name_translated()); ?></td>
                        <td>
    <?php
    if ($app->is_dirty()) {
        ?>
