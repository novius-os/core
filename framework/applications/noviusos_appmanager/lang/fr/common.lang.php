...
return array(
    ...
    #: views/admin/app_manager.view.php:39
    #: views/admin/app_manager.view.php:62
    #: views/admin/app_manager.view.php:132
    ...
    #: views/admin/app_manager.view.php:48
    'Installed applications' => 'Applications installées',

    #: views/admin/app_manager.view.php:61
    'Some recent changes' => 'Des changements récents',

    #: views/admin/app_manager.view.php:65
    'Up-to-date' => 'À jour',
    ...
    #: views/admin/app_manager.view.php:89
    'Available applications' => 'Applications disponibles',

    #: views/admin/app_manager.view.php:102
    'No metadata found' => 'Pas de metadata',

    #: views/admin/app_manager.view.php:106
    'Install' => 'Installer',

    #: views/admin/app_manager.view.php:128
    ...
    #: views/admin/app_manager.view.php:151
