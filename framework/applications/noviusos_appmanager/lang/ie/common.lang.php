...
return array(
    ...
    'OK, changes have been applied.' => 'OK, li changeaments ha esset aplicat.',

    #: classes/controller/admin/appmanager.ctrl.php:64
    'Great, a new app! Installed and ready to use.' => 'Magnific, un nov application! Installat e usabil.',

    #. The tab will be refreshed by the javaScript within the view
    #: classes/controller/admin/appmanager.ctrl.php:104
    'The application has been uninstalled.' => 'Li application ha esset desinstallat.',

    #. The tab will be refreshed by the javaScript within the view
    #: classes/controller/admin/appmanager.ctrl.php:133
    'Metadata was refreshed.' => 'Li meta-datas ha esset regenerat.',
    ...
    'All applications up-to-date.' => 'Omni applications es hodial.',

    #: views/admin/app_manager.view.php:54
    'Installed applications' => 'Applications installat',

    #: views/admin/app_manager.view.php:67
    'Some recent changes' => 'Recent changeaments',
