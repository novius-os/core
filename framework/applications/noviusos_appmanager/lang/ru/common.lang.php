...
return array(
    ...
    'OK, changes have been applied.' => 'OK, изменения были применены.',

    #: classes/controller/admin/appmanager.ctrl.php:64
    'Great, a new app! Installed and ready to use.' => 'Круто! Новое приложение установлено и готово к использованию.',

    #. The tab will be refreshed by the javaScript within the view
    #: classes/controller/admin/appmanager.ctrl.php:104
    'The application has been uninstalled.' => 'Приложение удалено.',

    #. The tab will be refreshed by the javaScript within the view
    #: classes/controller/admin/appmanager.ctrl.php:133
    'Metadata was refreshed.' => 'Метаданные были обновлены.',
