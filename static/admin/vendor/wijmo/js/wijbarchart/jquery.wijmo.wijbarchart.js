...
(function (wijmo) {
    ...
    WijBarChart.prototype.options = $.extend(true, {
        ...
        /// Type: Boolean.
        /// Code example:
        /// This code results in bars with data for three countries stacked to fill 100%
        /// of the chart area, with each series in a different color representing its
        ...
        /// Type: Number.
        /// Code example:
        /// this codes set the clusterOverlap.
        /// $("#wijbarchart").wijbarchart({
        ///	clusterOverlap: 50,
        ///	seriesList: [{
        ...
        /// Type: Object.
        /// Code example:
        /// this sample set the animation'd duration to 1000 and easing to "<".
        ///  $("#barchart").wijbarchart({
        ///      animation: {
        ...
        /// Type: Object.
        /// Code example:
        /// This code creates a chart with random data that regenerates when you click the button
        /// created in the second code snippet below.Paste this code into the < head > section
        /// of your HTML page, and the code below into the < body > section, open the page in
        /// a browser, and click the button to see the seriesTransition animation.
        /// Notice that any series that happens to not change does not show the animation.
