...
(function (wijmo) {
    ...
    var wijtreenode = (function (_super) {
        ...
        wijtreenode.prototype.getKeyCodeEnum = function () {
            if($.ui && $.ui.keyCode) {
                return $.ui.keyCode;
            }
    ...
    var wijtreecheck = (function (_super) {
            ...
            if(self.element.is("div")) {
                ...
                self.element.bind("mouseover.wijtreecheck", function () {
                    if(!self.options.disabled) {
                        self.$body.removeClass(css.stateDefault).addClass(css.stateHover);
                    }
        ...
        wijtreecheck.prototype.destory = function () {
    ...
    wijmo.wijtreecheck = wijtreecheck;    
    ...
    wijtree.prototype.options = $.extend(true, {
        ...
        /// { effect: "blind", easing: "linear", duration: 200 }).
        ///	</summary>
        {
            effect: "blind",
            easing: "linear",
