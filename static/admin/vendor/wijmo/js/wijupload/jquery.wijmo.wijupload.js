...
(function (wijmo) {
    ...
    wijupload.prototype.options = $.extend(true, {
        ...
        true,
        accept: /// <summary>
        /// Specifies the accept attribute of upload. This is an attribute of the file input. It is a filter that allows the "Choose File to Upload" dialog box to show the file list with the specified type.
        /// Possible values:
        ...
        /// </summary>
        "",
        enableSWFUploadOnIE: /// <summary>
        /// upload with SWFupload.swf,
        /// this option is used for multiple-select in IE.
        /// Type:Boolean.
        /// Default:false.
        /// Code Example:
        ///		$(".selector").wijupload("enableSWFUploadOnIE", true)
        /// </summary>
        false,
        enableSWFUpload: /// <summary>
        /// upload with SWFupload.swf in all browsers.
        /// Type:Boolean.
        /// Default:false.
        /// Code Example:
        ///		$(".selector").wijupload("enableSWFUpload", true)
        /// </summary>
        false,
        swfUploadOptions: /// <summary>
        /// For web control
        /// </summary>
        {
        },
