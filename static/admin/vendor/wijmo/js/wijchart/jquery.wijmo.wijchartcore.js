...
(function (wijmo) {
    ...
    wijmo.ChartDataUtil = ChartDataUtil;    
    ...
    var ChartTooltip = (function () {
        ...
        ChartTooltip.prototype._isWindowCollision = function (container, compass, offsetX, offsetY, ox, oy, windowCollisionDetection) {
            var box = container.getBBox(), counter = 0, cps = compass, x = box.x + ox, y = box.y + oy, w = this.paper.width, h = this.paper.height, offX = offsetX, offY = offsetY, strokeWidth = container.attr("stroke-width"), flip = windowCollisionDetection === true || windowCollisionDetection === "flip";
            if(Raphael.vml) {
    ...
    wijmo.ChartTooltip = ChartTooltip;    
    //for original API
    Raphael.fn.tooltip = {
    ...
    var WijChartCore = (function (_super) {
        ...
        **********************************************************************/
        ...
        WijChartCore.prototype.redraw = function (drawIfNeeded) {
            ...
            /// the chart already exists. If true, then the chart is redrawn only if it was
            /// not already created. If false, then the chart is redrawn, even if it already exists.
            // / </param>
    ...
    wijmo.WijChartCore = WijChartCore;    
    WijChartCore.prototype.options = $.extend(true, {
        ...
        /// Note: If you specify a width in the <div> element that is different from this value,
        /// the chart and its border go out of synch.
        // / Default: null.
        // / Type: Number.
        // / Code example:
        /// set the chart's width to 600px.
        ...
        null,
        height: // / <summary>
        // / Sets the height of the barchart in pixels. Note that this value overrides any value
        /// you may set in the <div> element that you use in the body of the HTML page
        /// Note: If you specify a height in the <div> element that is different from this value,
        /// the chart and its border go out of synch.
        // / Default: null.
        // / Type: Number.
        // / Code example:
        ...
        // / </summary>
        [],
        seriesStyles: // / <summary>
        // / Sets an array of style objects to use in rendering the bars for each series
        /// in the chart. Each style object in the array applies to one series in your seriesList,
        ...
        /// Each style object in the array applies to a series in your seriesList,
        ...
        marginTop: // / <summary>
        // / Sets the amount of space in pixels between the chart area and the top edge
        /// of the <div> that defines the widget
        // / Default: 25.
        // / Type: Number.
        // / Code example:
        // / $("#chartcore").wijchartcore({
        ...
        25,
        marginRight: // / <summary>
        // / Sets the amount of space in pixels between the chart area and the right edge
        /// of the <div> that defines the widget
        // / Default: 25.
        // / Type: Number.
        // / Code example:
        ...
        // / Sets the amount of space in pixels between the chart area and the bottom edge
        /// of the <div> that defines the widget.
        // / Default: 25.
        // / Type: Number.
        // / Code example:
        ...
        25,
        marginLeft: // / <summary>
        // / Sets the amount of space in pixels between the chart area and the left edge
        /// of the <div> that defines the widget
        // / Default: 25.
        // / Type: Number.
        // / Code example:
        ...
        /// have other style options set. Each type of text in the chart has a different
        /// set of styles applied by default, but if those styles are set to null,
        /// or if a particular style option is not set by default, the chart falls back on
        /// any style options you set in this option.
        /// Styles for specific types of chart text that may use this option as a fallback
        /// style are set in the following options:
        ///		axis x labels style
        ///		axis x textStyle
        ///		axis y labels style
        ///		axis y textStyle
        ...
        // / </summary>
        {
            ...
            /// If you leave this as an empty string, no header renders, regardless
            /// of any other header attributes.
            // / Default: "".
            // / Type: String.
            // / </summary>
            "",
        ...
        // / </summary>
        {
            ...
            /// If you leave this as an empty string, no footer renders, regardless of any
            /// other footer attributes.
            // / Default: "".
            // / Type: String.
            // / </summary>
            "",
            ...
            /// For more information on other style attributes that you can use
        ...
        legend: // / <summary>
        // / Creates a legend object to display with the chart. By default, each series
        /// that you create in the seriesList is represented by a color in the legend,
        ...
        // / </summary>
        {
            ...
            "",
            textMargin: // / <summary>
            // / A value in pixels that indicates the amount of space to leave around the text
            /// inside the legend.
            ...
            null,
            textStyle: // / <summary>
            // / A value that indicates the style of the series label text.
            /// The text values come from the seriesList labels.
            /// Note: Any style options set in the fallback textStyle option are used for
            /// any style options that are not set explicitly (or set by default) in this option.
            ...
            titleStyle: // / <summary>
            // / A value that indicates the style of the legend title. The text for the
            /// title is set in the text attribute of the legend.
            /// Note: Any style options set in the fallback textStyle option are used for any
            /// style options that are not set explicitly (or set by default) in this option.
            ...
            "east",
            orientation: // / <summary>
            // / A value that indicates the orientation of the legend. Vertical orientation generally
            /// works better with an east or west compass setting for the legend, while
            /// horizontal is more useful with a north or south compass setting and a small
            ...
            "vertical",
            visible: // / <summary>
            // / A value that indicates whether to show the legend.
            /// Set this value to false to hide the legend.
            // / Default: true.
            // / Type: Boolean.
            // / </summary>
            true
        ...
        // / </summary>
        {
            ...
            // / </summary>
            {
                ...
                // / </summary>
                {
                    ...
                    /// Note: Any style options set in the fallback textStyle option are
                    /// used for any style options that are not set explicitly (or set
                    /// by default) in this option.
                ...
                /// If you set this value to false, in order to show major tick marks on the
                /// axis, you must specify a value for the min option.
                // / Default: true.
                // / Type: Boolean.
                // / </summary>
                true,
                autoMax: // / <summary>
                // / A value that indicates whether to calculate the axis maximum value
                /// automatically. If you set this value to false, in order to show major
                /// tick marks on the axis, you must specify a value for the max option.
                // / Default: true.
                // / Type: Boolean.
                // / </summary>
                true,
                ...
                null,
                autoMajor: // / <summary>
                // / A value that indicates whether to calculate the major tick mark values
                /// automatically. If you set this value to false, in order to show major
                /// tick marks on the axis, you must specify a value for the unitMajor option.
                // / Default: true.
                // / Type: Boolean.
                // / </summary>
                true,
                autoMinor: // / <summary>
                // / A value that indicates whether to calculate the minor tick mark values
                /// automatically. If you set this value to false, in order to show minor tick marks
                /// on the axis, you must specify a value for the unitMinor option.
                // / Default: true.
                // / Type: Boolean.
                // / </summary>
                true,
                ...
                tickMajor: // / <summary>
                // / Creates an object with all of the settings to use in drawing tick marks that appear
                /// next to the numeric labels for major values along the X axis..
                ...
                {
                    position: // / <summary>
                    // / A value that indicates the position of the major tick mark in relation
                    /// Valid Values:
                    ///		none
                    ///		inside
                    ///		outside
                ...
                ///		"valueLabels" Uses the array of string values that you provide in the valueLabels option to annotate the axis.
                // / Default: "values".
                // / Type: String.
                // / </summary>
                "values",
                annoFormatString: // / <summary>
                // / The annoFormatString option uses Standard Numeric Format Strings to provide
                /// formatting for numeric values in axis labels.
                // / Default: "".
                // / Type: String.
                // / </summary>
                "",
            ...
            // / </summary>
            {
                ...
                // / </summary>
                {
                    ...
                    /// Note: Any style options set in the fallback textStyle option are used
                    /// for any style options that are not set explicitly (or set by default)
                    /// in this option.
                    // / Default: {fill: "#333","font-size": 11}.
                    // / Type: Object.
                    /// the style is defined in Raphael here is the documentation:
        ...
        // tickLabel: "nextToAxis",
        // / <summary>
        // / Creates an object to use as the tooltip, or hint, when the mouse is over a bar.
        /// By default, it displays the value of the seriesList label and Y data for the bar.
        ...
        // / </summary>
        {
            ...
            ///		The seriesList option's label attribute, which shows "undefined" if you
            ///			do not provide a label value
            ...
            /// above the content. In the image below, we set the title to "Title" and set the
            /// titleStyle to {fill: "yellow"}.
            // / Default: null.
            // / Type: String or Function.
            // / </summary>
            null,
            ...
            animated: // / <summary>
            // / A value that indicates the effect to use when showing or hiding the hint when
            /// showAnimated or hideAnimated is not specified. The only animation style included
            /// is "fade." If you want a different one, you can create a custom animation
            // / Default:"fade".
            // / Type:String.
            // / </summary>
            "fade",
            showAnimated: // / <summary>
            // / A value that indicates the animation effect to use when the hint appears after you
            /// mouse into the bar. This allows you to use a different effect when you mouse out of
            /// a bar than when you mouse in. (See also hideAnimated.) If you set this value to
            /// null, the animated property supplies the animation effect to use. The only
            /// animation style included is "fade." If you want a different one, you can create
            /// a custom animation
            // / Default:"fade".
            // / Type:String.
            // / </summary>
            "fade",
            hideAnimated: // / <summary>
            // / A value that indicates the animation effect to use when the hint goes away after you
            /// mouse out of the bar. This allows you to use a different effect when you mouse into a bar
            /// than when you mouse out. (See also showAnimated.) If you set this value to null,
            /// the animated property supplies the animation effect to use. The only animation style
            /// included is "fade." If you want a different one, you can create a custom animation
            // / Default:"fade".
            // / Type:String.
            // / </summary>
            "fade",
            duration: // / <summary>
            // / A value that indicates the number of milliseconds it takes to show or hide the
            /// hint when you mouse over or mouse out of a bar with the showDuration or
            /// hideDuration attribute set to null.
            // / Default:120.
            // / Type:Number.
            // / </summary>
            120,
            showDuration: // / <summary>
            // / A value that indicates the number of milliseconds it takes for the indicated animation
            /// effect to completely show the tooltip. This allows you to use a different number
            /// of milliseconds when you mouse out of a bar than when you mouse in.
            // / Default:120.
            // / Type:Number.
            // / </summary>
            120,
            hideDuration: // / <summary>
            // / A value that indicates the number of milliseconds it takes for the indicated
            /// animation effect to completely hide the tooltip. This allows you to use a
            /// different number of milliseconds when you mouse into a bar than when you mouse out.
            // / Default:120.
            // / Type:Number.
            // / </summary>
            120,
            easing: // / <summary>
            // / A value that indicates the easing animation used to show or hide the hint when
            /// you mouse over or mouse out of a bar with the showEasing or hideEasing attribute
            /// set to null.
            ...
            "",
            showEasing: // / <summary>
            // / A value that indicates the easing effect to use when the hint appears after you
            /// mouse into the bar. This allows you to use a different effect when you mouse
            /// out of a bar than when you mouse in. (See also hideEasing.) If you set this
            /// value to null, the easing property supplies the easing effect to use.
            // / Default: "".
            // / Type: String.
            // / </summary>
            "",
            hideEasing: // / <summary>
            // / A value that indicates the easing effect to use when the hint goes away after
            /// you mouse out of the bar. This allows you to use a different effect when you
            /// mouse into a bar than when you mouse out. (See also showEasing.) If you set
            /// this value to null, the easing property supplies the easing effect to use.
            // / Default: "".
            // / Type: String.
            // / </summary>
            "",
            showDelay: /// <summary>
            /// A value that indicates the number of milliseconds to wait before showing the
            /// hint after the mouse moves into the bar. This allows you to use a different
            /// number of milliseconds when you mouse out of a bar than when you mouse in.
            /// Default: 0.
            /// Type: Number.
            /// </summary>
            0,
            hideDelay: // / <summary>
            // / A value that indicates the number of milliseconds to wait before hiding the hint
            /// after the mouse leaves the bar. This allows you to use a different number of
            /// milliseconds when you mouse into a bar than when you mouse out.
            // / Default: 150.
            // / Type: Number.
            // / </summary>
            150,
            compass: // / <summary>
            // / A value that indicates the compass position of the callout (the small
            /// triangle that points from the main hint box to the bar it describes) in
            /// relation to the hint box.
            /// Valid Values:
            ///		west
            ///		east
            ///		south
            ...
            "north",
            offsetX: // / <summary>
            // / A value that indicates the horizontal distance in pixels from the mouse
            /// pointer to the callout triangle of the hint. The position of the callout
            /// triangle depends on the compass setting of the hint callout.
            // / Default: 0.
            // / Type: Number.
            // / </summary>
            0,
            offsetY: // / <summary>
            // / A value that indicates the vertical distance in pixels from the mouse pointer
            /// to the callout triangle of the hint. The position of the callout triangle
            /// depends on the compass setting of the hint callout.
            // / Default: 0.
            // / Type: Number.
            // / </summary>
            0,
            showCallout: // / <summary>
            // / Determines whether to show the callout element, the small triangle that
            /// points from the main hint box to the bar it describes. To change the
            /// appearance of the callout, see these other hint attributes: calloutFilled,
            ///calloutFilledStyle, and compass.
            // / Default:true.
            // / Type:Boolean.
            // / </summary>
            true,
            calloutFilled: // / <summary>
            // / Determines whether to fill the callout (the small triangle that points from
            /// the main hint box to the bar it describes). If you set it to true, the
            /// callout triangle uses the colors you specify in the calloutFilledStyle
            /// attribute. Otherwise, it takes on the colors of the style attribute of the hint.
            // / Default:false.
            // / Type:Boolean.
            // / </summary>
            false,
            calloutFilledStyle: // / <summary>
            // / A value that indicates the style to use in rendering the callout (the small
            /// triangle that points from the main hint box to the bar it describes). In order
            /// for this attribute of the callout to take effect, you must also set the
            /// calloutFilled attribute to true. Otherwise, it takes on the colors of the
            /// style attribute of the hint.
            // / Default: {fill: "#000"}.
            // / Type: Object.
            /// the style is defined in Raphael here is the documentation:
            /// http://raphaeljs.com/reference.html#Element.attr.
        ...
        indicator: /// <summary>
        /// Sets up an object that can display an indicator line running horizontally/vertically
        /// through the center of each chart element in the chart when the user clicks the chart element.
        /// Default: indicator: {visible: false, style: { stroke: "#000000" } }
        /// Code example:
        /// enable the indicator line when show tooltip
        /// $("#chartcore").wijchartcore({indicator:{visible: true}});
        /// </summary>
        {
            visible: /// <summary>
            /// A value that indicates whether to show indicator lines when the user clicks
            /// a chart element in the chart.
            /// </summary>
            false,
            style: /// <summary>
            /// A value that contains the fill color and outline color (stroke) of the
            /// indicator lines. Note that when you set the stroke color of the indicator line,
            /// it extends this color to the outline of the #hint:hint for the duration
            /// of the click.
            /// </summary>
            {
                stroke: "#000000"
        ...
        // / Sets the numeric format of the chart labels that show the value of each chart
        /// element. You can use Standard Numeric Format Strings.
        // / Default: "".
        // / Type: String.
        // / Code example:
        // / $("#chartcore").wijchartcore({
        ...
        // / </summary>
        "",
        disableDefaultTextStyle: // / <summary>
        // / Sets a value indicating whether you can set the font-family of the text using a
        ...
        true,
        dataSource: /// <summary>
        /// Sets the array to use as a source for data that you can bind to the axes in your
        /// seriesList. Use the data option, and bind values to your X and Y axes.
        ...
        /// </summary>
        null,
        beforeSeriesChange: // / <summary>
        // / This event fires before the series changes. This event can be cancelled.
        ...
        null,
        beforePaint: // / <summary>
        // / This event fires before the canvas is painted. This event can be cancelled.
        // / "return false;" to cancel the event.
        // / Default: null.
        // / Type: Function.
        // / </summary>
