...
(function (wijmo) {
    ...
    var WijGallery = (function (_super) {
        ...
        WijGallery.prototype._applyBtnStyle = function (dir) {
            var self = this, o = self.options, isNext = dir === "next", btn = self[dir + "Btn"], at = isNext ? "right center" : "left center", my = at, wijCSS = o.wijCSS, css = isNext ? wijCSS.cornerLeft : wijCSS.cornerRight, condition = dir === "next" ? (self.currentIdx >= self.count) : (self.currentIdx <= 0), nextPosition = {
                collision: "none",
                of: self.frame,
                my: my,
                at: at
        ...
        WijGallery.prototype._createThumbnails = function () {
            ...
            self.ul.children("li").each(function (i, data) {
                var link = $(data).children("a"), data = self.images[i], href = data.thumbUrl;
                if(!link.length) {
                    link = $(_this).wrapInner("<a>").children("a");
                    link.attr("href", href);
                }
            });
        ...
        WijGallery.prototype.count1 = function (c) {
            return this.count;
        };
        ...
        WijGallery.prototype.add = function (ui, index) {
            /// <summary>
        ...
        WijGallery.prototype.remove = function (index) {
            /// <summary>
