...
(function (wijmo) {
    var WijPieChart = (function (_super) {
        ...
        WijPieChart.prototype.getSector = /*****************************
        ...
        ******************************/
        ...
        WijPieChart.prototype._bindData = /** end of public methods */
        /** private methods */
    ...
    WijPieChart.prototype.options = $.extend(true, {
        ...
        /// Default: {enabled:true, duration:400, easing: "easeInCubic", offset: 10}.
        /// Type: Object.
        /// Code example:
        ///  $("#piechart").wijpiechart({
    ...
    var PieChartRender = (function () {
        ...
        PieChartRender.prototype.render = function () {
            ...
            }, getDiffAttrs = wijmo.ChartUtil.getDiffAttrs, canvas = o.canvas, getPositionByAngle = $.wijraphael.getPositionByAngle, seriesList = o.seriesList, seriesStyles = o.seriesStyles, seriesHoverStyles = o.seriesHoverStyles, stylesLength = seriesStyles.length, textStyle = o.textStyle, labelsOpts = o.labels || {
                style: {
                },
                formatString: "",
                formatter: null,
            ...
            canvas.customAttributes.segment = function (x, y, a1, a2, outerR, innerR) {
                ...
                if(innerR) {
                    path = wijmo.ChartUtil.donut(x, y, outerR, innerR, a1, a2);
                } else {
                    path = wijmo.ChartUtil.sector(x, y, outerR, a1, a2);
                }
                return {
                    "path": path
                };
    ...
    wijmo.PieChartRender = PieChartRender;    
})(wijmo || (wijmo = {}));
