...
(function (wijmo) {
    ...
    var WijLightBox = (function (_super) {
        ...
        WijLightBox.prototype.getKeyCodeEnum = function () {
            if($.ui && $.ui.keyCode) {
                return $.ui.keyCode;
            }
        ...
        WijLightBox.prototype.destroy = function () {
            /// <summary>
