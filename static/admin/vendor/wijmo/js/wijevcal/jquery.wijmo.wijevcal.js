...
(function (wijmo) {
    ...
    var wijevcal = (function (_super) {
        ...
        wijevcal.prototype.localizeString = ///
        ...
        wijevcal.prototype._initLocalDataStorage = function () {
            ...
            try  {
                ...
                ensureTableCreated("events", "(id TEXT PRIMARY KEY, calendar TEXT, subject TEXT, location TEXT, " + "start TIMESTAMP, end TIMESTAMP, description TEXT, color TEXT, " + "allday INTEGER, properties TEXT, tag TEXT)", $.proxy(this._loadData, this));
                //();
                /*
                TEXT
                NUMERIC
        ...
        wijevcal.prototype._loadData = function () {
            var o = this.options, self = this, i, count, cal, appt, calendarsById, eventsDataById, query, loadCalendarsCallback, loadEventsCallback, errorCallback;
            //successCallback
            this.showLoadingLabel();
        ...
        wijevcal.prototype.getOccurrences = /// <summary>
        ...
        wijevcal.prototype.beginUpdate = /// <summary>
        ...
        wijevcal.prototype.endUpdate = /// <summary>
        /// Use beginUpdate and endUpdate when making a large number of changes
        ///	to widget options.
        /// Code Example:
        ///	$("#wijevcal").wijevcal("beginUpdate");
        ...
        wijevcal.prototype.goToTime = /// <summary>
        ...
        wijevcal.prototype.refresh = /// <summary>
        ...
        wijevcal.prototype.invalidate = /// <summary>
        /// Invalidates the entire surface of the control
        /// and causes the control to be redrawn.
        /// </summary>
        function () {
        ...
        wijevcal.prototype.findEventById = ///
        ...
        wijevcal.prototype.status = /// <summary>
