...
define("jquery-nos-listgrid",["jquery","jquery-nos","jquery-ui.widget","wijmo.wijgrid"],function(a){a.widget("nos.noslistgrid",a.wijmo.wijgrid,{options:{culture:a.nosLang.substr(0,2),loadingText:"Loading..."},_init:function(){var d=this,e=d.options;if(a.isFunction(e.columnResized)){var b=e.columnResized}e.columnResized=function(h,f){var g=d.option("columns");a.extend(g[f.column.thX],{ensurePxWidth:true,width:f.column.width});d.setSize(d.outerDiv.parent().width());if(a.isFunction(b)){b.apply(this,arguments)}};if(a.isFunction(e.dataLoaded)){var c=e.ajaxError}e.ajaxError=function(h,f){var g=f.XMLHttpRequest;if(g.status==403){a(this).nosAjaxError(g)}if(a.isFunction(c)){c.apply(this,arguments)}};d._super()}});return a});
...
define("jquery-nos-appdesk",["jquery","jquery-nos","jquery-ui.widget","jquery-nos-thumbnailsgrid","jquery-nos-listgrid","jquery-nos-treegrid","jquery-nos-preview","jquery-ui.button","wijmo.wijtabs","wijmo.wijsuperpanel","wijmo.wijsplitter","wijmo.wijgrid","wijmo.wijmenu"],function(b){var c=void (0),a=function(d){wijhttpproxy.call(this,d)};a.prototype=b.extend({},wijhttpproxy.prototype,{request:function(e,f,d){if(this._appdeskxhr){this._appdeskxhr.abort()}this._appdeskxhr=wijhttpproxy.prototype.request.call(this,e,f,d);return this._appdeskxhr}});b.widget("nos.appdesk",{options:{buttons:[],inspectors:[],thumbnails:false,defaultView:"grid",locales:{},sites:{},culture:b.nosLang.substr(0,2),contexts:{},hideContexts:false,texts:{allSites:"All sites",allLanguages:"All languages",allContexts:"All contexts",settings:"Settings",item:"item",items:"items",showNbItems:["Showing 1 item out of {{y}}","Showing {{x}} items out of {{y}}"],showNoItem:"No items",showNbTotal:"({{nb}} in total)",NItems:["1 item","{{count}} items"],showAll:"Show all items",viewGrid:"List",viewTreeGrid:"Tree",viewThumbnails:"Thumbnails",selectSites:"Select the site(s) to show",selectLanguages:"Select the language(s) to show",selectContexts:"Select the context(s) to show",workInContext:"Show {{context}}",otherSites:"Other sites",otherLanguages:"Other languages",otherContexts:"Other contexts",contextsPopinOk:"OK",loading:"Loading...",search:"Search"},values:{},slidersChange:null,splitters:{vertical:null,horizontal:null},views:{},selectedView:null,selectedContexts:[],fromView:null,name:null,grid:{}},pageIndex:0,showFilter:false,gridRendered:false,nosContext:false,resizing:true,init:false,itemSelected:null,variantColumnsProperties:{visible:true,width:true,showFilter:true},variantInspectorsProperties:{hide:true,vertical:true},_create:function(){var d=this,e=d.options;d.element.addClass("nos-appdesk");d.dispatcher=d.element.closest(".nos-dispatcher");if(!d.dispatcher.size()){d.dispatcher=d.element}d.element.nosToolbar("create");d.uiSplitterVertical=b("<div></div>").addClass("nos-appdesk-splitter-v").appendTo(d.element);d.uiSplitterVerticalRight=b("<div></div>").appendTo(d.uiSplitterVertical);d.uiInspectorsVertical=b("<ul></ul>").addClass("nos-appdesk-inspectors nos-appdesk-inspectors-v").appendTo(d.uiSplitterVerticalRight);d.uiSplitterVerticalLeft=b("<div></div>").appendTo(d.uiSplitterVertical);d.uiSplitterHorizontal=b("<div></div>").appendTo(d.uiSplitterVerticalLeft);d.uiSplitterHorizontalTop=b("<div></div>").appendTo(d.uiSplitterHorizontal);d.uiInspectorsHorizontal=b("<ul></ul>").addClass("nos-appdesk-inspectors nos-appdesk-inspectors-h").appendTo(d.uiSplitterHorizontalTop);d.uiSplitterHorizontalBottom=b("<div></div>").appendTo(d.uiSplitterHorizontal);d.uiSearchBar=b("<div><form><div></div></form></div>").addClass("nos-appdesk-searchbar-container wijmo-wijgrid ui-widget ui-widget-header ui-state-default").appendTo(d.uiSplitterHorizontalBottom).find("form").addClass("wijmo-wijgrid-headerrow wijmo-wijgrid-innercell").find("div").addClass("nos-appdesk-searchbar wijmo-wijgrid-headertext");d.uiNbResult=b("<div></div>").addClass("nos-appdesk-nbresult").appendTo(d.uiSearchBar);d.uiInputContainer=b("<div></div>").addClass("nos-appdesk-input-container ui-widget-content ui-corner-all").appendTo(d.uiSearchBar);d.uiViewsButtons=b("<div></div>").addClass("nos-appdesk-views-button").appendTo(d.uiSearchBar);d.uiSearchIcon=b("<div></div>").addClass("nos-appdesk-search-icon ui-icon ui-icon-search").appendTo(d.uiInputContainer);d.uiSearchInput=b('<input type="search" name="search" placeholder="'+e.texts.search+'" value="" />').addClass("nos-appdesk-search-input ui-helper-reset").appendTo(d.uiInputContainer);d.uiInspectorsTags=b("<div></div>").addClass("nos-appdesk-inspectorstags").appendTo(d.uiInputContainer);d.uiResetSearch=b('<a href="#"></a>').html(e.texts.showAll).attr("title",e.texts.showAll).addClass("nos-appdesk-reset-search").appendTo(d.uiInputContainer);d.uiuiResetSearchIcon=b("<span></span>").html(e.texts.showAll).addClass("ui-icon").appendTo(d.uiResetSearch);d.uiGridTitle=b("<div></div>").addClass("nos-appdesk-title").appendTo(d.uiSearchBar);d.uiPaginationLabel=b("<span></span>").addClass("nos-appdesk-pagination");d.uiGrid=b("<table></table>").appendTo(d.uiSplitterHorizontalBottom);d.uiTreeGrid=b("<table></table>").appendTo(d.uiSplitterHorizontalBottom);d.uiThumbnail=b("<div></div>").appendTo(d.uiSplitterHorizontalBottom)},_init:function(){var d=this,e=d.options;if(!b.isPlainObject(e.thumbnails)){e.thumbnails=false}else{e.thumbnails=b.extend({thumbnailSize:128},e.thumbnails)}if(!e.texts.gridTitle){e.texts.gridTitle=e.texts.items}d.nosContext=b.nosContext({locales:e.locales,sites:e.sites,contexts:e.contexts});if(!b.isEmptyObject(e.contexts)){if(!b.isArray(e.selectedContexts)){e.selectedContexts=b.type(e.selectedContexts)==="string"?[e.selectedContexts]:[]}b.each(e.selectedContexts,function(g,f){if(!e.contexts[f]){delete e.selectedContexts[f]}});if(e.selectedContexts.length===0){e.selectedContexts.push(Object.keys(e.contexts)[0])}}d._css()._uiToolbar()._uiSplitters()._uiInspectors()._uiSearchBar()._uiList();d.init=true},_css:function(){var l=this,e=l.options;if(!b("style#inspectorsGrid").length){var g="";for(var j=0,f=document.styleSheets.length;j<f;j++){var h=document.styleSheets[j];if(h.href&&/wijmo/.test(h.href)){var i=h.rules?h.rules:h.cssRules;for(var d=0,k=i.length;d<k;d++){if(i[d].selectorText===".ui-widget-content"){g+=".nos-appdesk .nos-appdesk-splitter-v .wijmo-wijsplitter-v-panel2 .wijmo-wijsplitter-h-panel1 .wijmo-wijgrid-alternatingrow {background:"+i[d].style.background+";}";g+=".nos-appdesk .nos-appdesk-splitter-v .wijmo-wijsplitter-v-panel1 .wijmo-wijgrid-alternatingrow {background:"+i[d].style.background+";}"}if(i[d].selectorText===".wijmo-wijgrid tr.wijmo-wijgrid-row.ui-state-hover, .wijmo-wijgrid .wijmo-wijgrid-current-cell, .wijmo-wijgrid td.wijmo-wijgrid-rowheader.ui-state-active"||i[d].selectorText===".wijmo-wijgrid tr.ui-state-hover.wijmo-wijgrid-row, .wijmo-wijgrid .wijmo-wijgrid-current-cell, .wijmo-wijgrid td.ui-state-active.wijmo-wijgrid-rowheader"){g+=".nos-appdesk .nos-appdesk-splitter-v .wijmo-wijsplitter-v-panel2 .wijmo-wijsplitter-h-panel1 .wijmo-wijgrid-alternatingrow.ui-state-hover {background:"+i[d].style.background+";}";g+=".nos-appdesk .nos-appdesk-splitter-v .wijmo-wijsplitter-v-panel1 .wijmo-wijgrid-alternatingrow.ui-state-hover {background:"+i[d].style.background+";}"}}}}b('<style type="text/css" id="inspectorsGrid">'+g+"</style>").appendTo("head")}return l},_uiToolbar:function(){var d=this;return d._uiToolbarActions()._uiToolbarContexts()._uiToolbarViews()},_uiToolbarActions:function(){var d=this,e=d.options;if(!b.isArray(e.buttons)||!e.buttons.length){return d}b.each(e.buttons,function(h,g){var f;if(g.primary){f=b("<button></button>").html(g.label).data("icon",g.icon||"plus").addClass("ui-priority-primary").click(function(i){i.preventDefault();i.stopImmediatePropagation();b(this).nosAction(g.action,{context:e.selectedContexts.length?e.selectedContexts[0]:""})})}else{f=b('<a href="#"></a>').addClass("nos-appdesk-action-secondary").html(g.label).click(function(i){i.preventDefault();i.stopImmediatePropagation();b(this).nosAction(g.action,{context:e.selectedContexts.length?e.selectedContexts[0]:""})})}d.element.nosToolbar("add",f)});return d},_uiToolbarContexts:function(){var e=this,h=e.options;if(h.hideContexts||!!b.isEmptyObject(h.contexts)){return e}e.dispatcher.data("nosContext",h.selectedContexts);e._uiToolbarContextsButton();e.uiToolbarContextsDialog=b("<div><form><table><thead><tr><th></th></tr></thead><tbody></tbody></table></form></div>");var f=e.uiToolbarContextsDialog.find("table"),d=f.find("tbody"),g=f.find("tr");b.each(h.locales,function(i,j){b("<th></th>").html(j.title).append('<br /><img src="static/novius-os/admin/novius-os/img/flags/'+j.flag+'.png" />').appendTo(g)});b.each(h.sites,function(j,i){var k=b("<tr></tr>").appendTo(d);b("<th></th>").html(i.title).appendTo(k);b.each(h.locales,function(l,m){if(h.contexts[j+"::"+l]){b("<td></td>").append('<input type="checkbox" name="contexts" value="'+j+"::"+l+'" />').appendTo(k)}else{b("<td></td>").appendTo(k)}})});e.uiToolbarContextsDialog.wijdialog({title:e.nosContext.label({oneSite:h.texts.selectLanguages,oneLocale:h.texts.selectSites,defaultLabel:h.texts.selectContexts}),autoOpen:false,buttons:[{text:h.texts.contextsPopinOk,click:function(){h.selectedContexts=[];e.uiToolbarContextsDialog.find(":checked").each(function(){h.selectedContexts.push(b(this).val())});if(h.selectedContexts.length===0){e.uiToolbarContextsDialog.find(":checkbox").each(function(){h.selectedContexts.push(b(this).val())})}e._selectContexts()}}],captionButtons:{pin:{visible:false},refresh:{visible:false},toggle:{visible:false},minimize:{visible:false},maximize:{visible:false}},modal:true,open:function(){e.uiToolbarContextsDialog.nosOnShow("show");e.uiToolbarContextsDialog.find(":checkbox").prop("checked",false);b.each(h.selectedContexts,function(k,j){e.uiToolbarContextsDialog.find(':checkbox[value="'+j+'"]').prop("checked",true)});e.uiToolbarContextsDialog.wijdialog("option","width",Math.min(parseInt(e.uiToolbarContextsDialog.css("padding-left").replace("px"))*2+f.outerWidth(),window.innerWidth-200))}}).nosOnShow("one",function(){f.wijgrid({scrollMode:"auto",columns:[{cellFormatter:function(i){i.$container.text(i.formattedValue).parent().addClass("wijmo-wijgrid-rowheader ui-widget-content ui-state-default").removeClass("wijdata-type-string");return true}}],cellStyleFormatter:function(i){if(i.state&b.wijmo.wijgrid.renderState.selected){i.$cell.removeClass("ui-state-highlight")}if(i._cellIndex>0){i.$cell.css("text-align","center");if(i.row.dataRowIndex===-1){var k=f.wijgrid("data");i.$cell.click(function(o){o.preventDefault();o.stopImmediatePropagation();var n=null;for(var l=1;l<=k.length;l++){var m=f.find("tr:eq("+l+")").find("td:eq("+i._cellIndex+")").find(":checkbox");if(n===null){n=m.is(":checked")}m.prop("checked",!n)}})}}else{var j=i.$cell.parent();i.$cell.click(function(m){m.preventDefault();m.stopImmediatePropagation();var l=j.find(":checkbox");l.prop("checked",!l.is(":checked"))})}}});e.uiToolbarContextsDialog.nosFormUI()});return e},_selectContexts:function(){var d=this,e=d.options;d.uiToolbarContextsDialog.wijdialog("close");d._uiToolbarContextsButtonLabel();d.element.nosSaveUserConfig(e.name+".selectedContexts",e.selectedContexts);d.uiSearchInput.val("");if(d.uiInspectorsTags.data("wijmo-wijsuperpanel")){d.uiInspectorsTags.wijsuperpanel("destroy")}d.uiInspectorsTags.empty();d._uiList();d.dispatcher.data("nosContext",e.selectedContexts).trigger("contextChange");return d},_uiToolbarContextsButton:function(){var e=this,i=e.options;var d=b("<div><button></button><button></button></div>").addClass("nos-appdesk-buttoncontext"),g=new Date(),j=g.getDate()+"_"+g.getHours()+"_"+g.getMinutes()+"_"+g.getSeconds()+"_"+g.getMilliseconds(),f=b("<ul></ul>"),h=0;d.find("button:first").click(function(k){k.preventDefault();k.stopImmediatePropagation();e.uiToolbarContextsDialog.wijdialog("open")}).end().find("button:last").attr("id",j).html(e.nosContext.label({oneSite:i.texts.selectLanguages,oneLocale:i.texts.selectSites,defaultLabel:i.texts.selectContexts})).data({text:false,icons:{primary:"triangle-1-s"}});e.uiToolbarContextsButton=e.element.nosToolbar("add",d,true);e.uiToolbarContextsButton.buttonset();e._uiToolbarContextsButtonLabel();b("<li><a></a></li>").appendTo(f).find("a").html(e.nosContext.label({oneSite:i.texts.selectLanguages,oneLocale:i.texts.selectSites,defaultLabel:i.texts.selectContexts}));b("<li></li>").appendTo(f);b.each(i.contexts,function(k){h++;b("<li><a></a></li>").data("context",k).appendTo(f).find("a").append(i.texts.workInContext.replace("{{context}}",e.nosContext.contextLabel(k)));if(h>10&&Object.keys(i.contexts).length>12){b("<li><a></a></li>").appendTo(f).find("a").html(e.nosContext.label({oneSite:i.texts.otherLanguages,oneLocale:i.texts.otherSites,defaultLabel:i.texts.otherContexts}));return false}});f.insertAfter(e.uiToolbarContextsButton).wijmenu({orientation:"vertical",animation:{animated:"slide",option:{direction:"up"},duration:50,easing:null},hideAnimation:{animated:"slide",option:{direction:"up"},duration:0,easing:null},direction:"rtl",trigger:"#"+j,select:function(m,l){var n=b(l.item.element),k=n.data("context");if(k){i.selectedContexts=[k];e._selectContexts()}else{e.uiToolbarContextsDialog.wijdialog("open")}}});return e},_uiToolbarContextsButtonLabel:function(){var f="",j=0,g=0,i={},d={},e=this,k=e.options,h=e.uiToolbarContextsButton.find("button:first");if(k.selectedContexts.length===1){h.button("option","label",e.nosContext.contextLabel(k.selectedContexts[0]))}else{b.each(k.selectedContexts,function(o,n){var m=e.nosContext.siteCode(n),l=e.nosContext.localeCode(n);if(!i[m]){j++;i[m]=[]}i[m].push(l);if(!d[l]){g++;d[l]=[]}d[l].push(m)});if(Object.keys(k.contexts).length===k.selectedContexts.length){h.button("option","label",e.nosContext.label({oneSite:k.texts.allLanguages,oneLocale:k.texts.allSites,defaultLabel:k.texts.allContexts}))}else{if(j===1&&k.sites[Object.keys(i)[0]].locales.length===g){h.button("option","label",e.nosContext.siteLabel(Object.keys(i)[0])+", "+k.texts.allLanguages)}else{if(g===1&&k.locales[Object.keys(d)[0]].sites.length===j){h.button("option","label",k.texts.allSites+", "+e.nosContext.localeLabel(Object.keys(d)[0]))}else{b.each(i,function(m,l){if(f!==""){f+="&nbsp;&nbsp;"}if(Object.keys(k.sites).length>1){f+=e.nosContext.siteLabel(m,{"short":true})+" "}if(Object.keys(k.locales).length>1){b.each(l,function(o,n){f+=e.nosContext.localeLabel(n,{"short":true})+" "})}});h.button("option","label",f)}}}}return e},_uiToolbarViews:function(){var e=this,g=e.options;if(g.views[g.selectedView]&&g.views[g.selectedView].virtual){return e}var d=b("<select></select>"),f=0;b.each(g.views,function(i,h){if(h.virtual){return}f++;d.append(b("<option></option>").attr("value",i).prop("selected",g.selectedView==i).append(h.name))});if(f<=1){return e}d.change(function(){var h=b(this);h.nosSaveUserConfig(g.name+".selectedView",b(this).val());e.element.trigger("reloadView",{selectedView:b(this).val()})});e.element.nosToolbar("add",d,true);return e},_uiSplitters:function(){var f=this,h=function(){f.uiSplitterHorizontal.wijsplitter("refresh");f._resizeInspectorsV(true)._resizeInspectorsH(true)._resizeList(true)},d=function(){f._resizeInspectorsH(true)._resizeList(true)},g=b.extend(true,{orientation:"vertical",splitterDistance:200,showExpander:false,fullSplit:false,panel1:{minSize:150,scrollBars:"none"},panel2:{minSize:200,scrollBars:"none"},expanded:function(){h()},collapsed:function(){h()},sized:function(){f.resizing=true;h()}},f.options.splitters.vertical),e=b.extend(true,{orientation:"horizontal",fullSplit:true,splitterDistance:200,showExpander:false,panel1:{minSize:200,scrollBars:"none"},panel2:{minSize:200,scrollBars:"none"},expanded:function(){d()},collapsed:function(){d()},sized:function(){f.resizing=true;d()}},f.options.splitters.horizontal);f.uiSplitterVertical.wijsplitter(g).find(".ui-resizable-handle").mousedown(function(){f.resizing=false});f.uiSplitterHorizontal.wijsplitter(e).find(".ui-resizable-handle").mousedown(function(){f.resizing=false});return f},_uiInspectors:function(){var d=this,e=d.options;b.each(e.inspectors,function(){if(!this.hide){b("<li></li>").addClass("nos-appdesk-inspector ui-widget-content").data("inspector",b.extend({loadingText:e.texts.loading},this)).appendTo(this.vertical?d.uiInspectorsVertical:d.uiInspectorsHorizontal)}});d._resizeInspectorsV(true)._resizeInspectorsH(true);d.uiInspectorsVertical.find("> li").add(d.uiInspectorsHorizontal.find("> li")).each(function(){d._loadInspector(b(this))});return d},_loadInspector:function(g){var d=this,f=g.data("inspector"),e=d.options;f.selectionChanged=function(l,j){var h=false,i=f.inputName;if(f.inputName.substr(-2,2)==="[]"){i=f.inputName.substr(0,f.inputName.length-2);h=true}if(!h){d.uiInspectorsTags.find("span."+i).remove()}else{var m=false;d.uiInspectorsTags.find("span."+i).each(function(){if(b(this).find("input").val()===l){m=true;return false}});if(m){return true}}d.pageIndex=0;if(d.uiInspectorsTags.data("wijmo-wijsuperpanel")){d.uiInspectorsTags.wijsuperpanel("destroy")}var k=b("<span></span>").addClass("nos-appdesk-inspectorstag ui-state-default ui-corner-all "+i).html(j).appendTo(d.uiInspectorsTags);b('<input type="hidden" name="'+f.inputName+'" />').val(l).appendTo(k);b('<a href="#"></a>').addClass("ui-icon ui-icon-close").click(function(n){n.preventDefault();b(this).parent().remove();d.gridReload()}).appendTo(k);d.uiInspectorsTags.wijsuperpanel({showRounder:false,hScroller:{scrollMode:"buttons"}});if(e.defaultView==="treeGrid"){d.uiViewsButtons.find(".view_grid").click().blur()}else{d.gridReload()}};g.data("inspector",f);if(b.isFunction(f.url)){f.url.call(d,g)}else{if(f.url){b.ajax({url:f.url,dataType:"html"}).done(function(h){b(h).appendTo(g)}).fail(function(h,j,i){log("error");log(j);log(i)})}else{g.html(f.view)}}return d},_uiSearchBar:function(){var e=this,g=e.options;e.uiResetSearch.hide();e.uiSearchInput.on("keypress",function(i){var j=b.ui.keyCode;e.pageIndex=0;if(e.timeoutSearchInput){clearTimeout(e.timeoutSearchInput)}if(i.keyCode===j.ENTER){if(g.defaultView==="treeGrid"){e.uiViewsButtons.find(".view_grid").click().blur()}else{e.gridReload()}return false}e.timeoutSearchInput=setTimeout(function(){if(g.defaultView==="treeGrid"){e.uiViewsButtons.find(".view_grid").click().blur()}else{e.gridReload()}},500)});e.uiResetSearch.click(function(i){i.preventDefault();e.uiSearchInput.val("");if(e.uiInspectorsTags.data("wijmo-wijsuperpanel")){e.uiInspectorsTags.wijsuperpanel("destroy")}e.uiInspectorsTags.empty();e.gridReload()});e.uiInspectorsTags.height(e.uiInputContainer.height()).width(parseInt(e.uiSearchBar.width()*0.3)).wijsuperpanel({showRounder:false,hScroller:{scrollMode:"buttons"}});var d=[{id:"treeGrid",text:g.texts.viewTreeGrid,icon:"view-tree"},{id:"grid",text:g.texts.viewGrid,icon:"view-list"},{id:"thumbnails",size:64,text:g.texts.viewThumbnails,icon:"view-thumbs-small"},{id:"thumbnails",size:128,text:g.texts.viewThumbnails,icon:"view-thumbs-big"}],f=new Date(),h=f.getDate()+"_"+f.getHours()+"_"+f.getMinutes()+"_"+f.getSeconds()+"_"+f.getMilliseconds();b.each(d,function(){var i=this;if(g[i.id]){b('<label for="view_'+h+i.id.toLowerCase()+(i.size?"_"+i.size:"")+'"></label>').html(i.text+(i.size?" "+i.size+"px":"")).appendTo(e.uiViewsButtons);b('<input type="radio" name="view" />').attr("id","view_"+h+i.id.toLowerCase()+(i.size?"_"+i.size:"")).prop("checked",(g.defaultView===i.id&&(!i.size||i.size===g.thumbnails.thumbnailSize))).addClass("view_"+i.id.toLowerCase()+(i.size?"_"+i.size:"")).appendTo(e.uiViewsButtons).button({text:false,label:i.text+(i.size?" "+i.size+"px":""),icons:{primary:"ui-icon "+i.icon,secondary:null}}).click(function(){if(g.defaultView!==i.id||(i.id==="thumbnails"&&g.thumbnails.thumbnailSize!==i.size)){e.uiViewsButtons.find("button").removeClass("ui-state-active");b(this).addClass("ui-state-active");g.defaultView=i.id;if(i.size){g.thumbnails.thumbnailSize=i.size}if(i.id==="treeGrid"){e.uiSearchInput.val("");e.uiResetSearch.hide();e.uiNbResult.hide()}e._uiList()}})}});if(e.uiViewsButtons.find("input").length>1){e.uiViewsButtons.buttonset()}else{e.uiViewsButtons.hide()}return e},_uiList:function(){var d=this,e=d.options;d.gridRendered=false;d.uiGridTitle.html(e.texts.gridTitle);if(d.uiThumbnail.data("nos-thumbnailsgrid")){d.uiThumbnail.thumbnailsgrid("destroy")}if(d.uiGrid.data("nos-noslistgrid")){d.uiGrid.noslistgrid("destroy")}if(d.uiTreeGrid.data("nos-nostreegrid")){d.uiTreeGrid.nostreegrid("destroy")}d.uiThumbnail.add(d.uiGrid).add(d.uiTreeGrid).empty().hide();if(e.defaultView==="thumbnails"){d.uiThumbnail.show();d._uiThumbnail()}else{if(e.defaultView==="treeGrid"){d.uiTreeGrid.show();d._uiTreeGrid()}else{d.uiGrid.show();d._uiGrid()}}return d},_uiGrid:function(){var f=this,j=f.options,e=f.uiGrid.offset(),h=f.element.offset(),d=f.element.height()-e.top+h.top,i=b.grid.getHeights(),g=b.extend(true,{},j.grid);f._columnsMultiContext(g.columns);f.uiGrid.css({height:d,width:"100%"}).noslistgrid(b.extend({loadingText:j.texts.loading,columnsAutogenerationMode:"none",selectionMode:"singleRow",showFilter:f.showFilter,allowSorting:true,scrollMode:"auto",allowPaging:true,culture:j.culture,pageIndex:f.pageIndex,pageSize:Math.floor((d-i.footer-i.header-(f.showFilter?i.filter:0))/i.row),allowColSizing:true,allowColMoving:true,data:new wijdatasource({dynamic:true,proxy:new a({url:j.grid.urlJson,dataType:"json",error:function(k,m,l){log(k,m,l)},data:{}}),loading:function(m,k){var l=k.data.paging;f.pageIndex=l.pageIndex;if(f.gridRendered){f.uiGrid.noslistgrid("currentCell",-1,-1)}m.proxy.options.data.context=j.selectedContexts||"";m.proxy.options.data.inspectors=f._jsonInspectors();m.proxy.options.data.offset=l.pageIndex*l.pageSize;m.proxy.options.data.limit=l.pageSize},loaded:function(l,k){if(l.data.totalRows===0){f.uiPaginationLabel.html(j.texts.showNoItem);f.uiNbResult.html(j.texts.showNoItem)}else{f.uiPaginationLabel.html(b.nosI18nPlural(j.texts.showNbItems,l.data.length).replace("{{x}}",l.data.length).replace("{{y}}",l.data.totalRows));f.uiNbResult.html(b.nosI18nPlural(j.texts.NItems,l.data.totalRows).replace("{{count}}",l.data.totalRows))}f.uiNbResult.show();f.uiResetSearch[f.uiInspectorsTags.find(".nos-appdesk-inspectorstag").length||f.uiSearchInput.val()?"show":"hide"]()},reader:{read:function(l){var k=parseInt(l.data.total,10);l.data=l.data.items;l.data.totalRows=k}}}),pageIndexChanging:function(){f.element.trigger("selectionChanged.appdesk",false)},cellStyleFormatter:function(k){if(k.$cell.is("th")){k.$cell.removeClass("ui-state-active")}if(k.state&b.wijmo.wijgrid.renderState.selected&&k.$cell.hasClass("ui-state-default")){k.$cell.removeClass("ui-state-highlight")}if(k.state&b.wijmo.wijgrid.renderState.selected){k.$cell.removeClass("wijmo-wijgrid-current-cell")}},currentCellChanging:function(){return f.gridRendered},currentCellChanged:function(l){if(l){var m=b(l.target).noslistgrid("currentCell").row(),k=m?m.data:false;if(k){f.itemSelected=b.extend({},k);f.element.trigger("selectionChanged.appdesk",k)}}return true},rendering:function(){f.gridRendered=false},rendered:function(){f.gridRendered=true;f.uiGrid.css("height","auto");var k=f.uiGrid.noslistgrid("selection");k&&k.clear();if(f.itemSelected!==null){b.each(f.uiGrid.noslistgrid("data")||[],function(l,m){if(m._model==f.itemSelected._model&&m._id==f.itemSelected._id){k.addRows(l);f.element.trigger("selectionChanged.appdesk",m)}})}},dataLoading:function(k){f.uiPaginationLabel.detach()},loaded:function(){f.uiSplitterHorizontalBottom.find(".wijmo-wijgrid-footer").prepend(f.uiPaginationLabel)}},g));return f},_uiTreeGrid:function(){var f=this,j=f.options,e=f.uiTreeGrid.offset(),i=f.element.offset(),d=f.element.height()-e.top+i.top,h=b.extend(true,{},j.grid),g=b.extend({},j.treeGrid.columns||j.grid.columns);delete h.columns;delete h.urlJson;f._columnsMultiContext(g);f.uiTreeGrid.css({height:d,width:"100%"}).nostreegrid(b.extend(true,{loadingText:j.texts.loading,urlJson:j.treeGrid.urlJson,treeOptions:{context:j.selectedContexts||""},initialDepth:j.treeGrid.initialDepth||2,columnsAutogenerationMode:"none",selectionMode:"singleRow",allowSorting:true,scrollMode:"auto",culture:j.culture,allowColSizing:true,allowColMoving:true,columns:j.treeGrid.columns||j.grid.columns,sorting:function(l,k){b.each(j.grid.columns,function(){var m=this;if(m.headerText===k.column.headerText){m.sortDirection=k.sortDirection}else{m.sortDirection="none"}});f.uiViewsButtons.find(".view_grid").click().blur();return false},cellStyleFormatter:function(k){if(k.$cell.is("th")){k.$cell.removeClass("ui-state-active")}if(k.state&b.wijmo.wijgrid.renderState.selected&&k.$cell.hasClass("ui-state-default")){k.$cell.removeClass("ui-state-highlight")}if(k.state&b.wijmo.wijgrid.renderState.selected){k.$cell.removeClass("wijmo-wijgrid-current-cell")}},currentCellChanging:function(){return f.gridRendered},currentCellChanged:function(l){if(l){var m=b(l.target).nostreegrid("currentCell").row(),k=m?m.data:false;if(k){f.itemSelected=b.extend({},k);f.element.trigger("selectionChanged.appdesk",k)}}return true},rendering:function(){f.gridRendered=false},rendered:function(){f.gridRendered=true;f.uiTreeGrid.css("height","auto");var k=f.uiTreeGrid.nostreegrid("selection");k&&k.clear();if(f.itemSelected!==null){b.each(f.uiTreeGrid.nostreegrid("data")||[],function(l,m){if(m._model==f.itemSelected._model&&m._id==f.itemSelected._id){k.addRows(l);f.element.trigger("selectionChanged.appdesk",m)}})}},dataLoading:function(k){f.uiPaginationLabel.detach()},loaded:function(){f.uiSplitterHorizontalBottom.find(".wijmo-wijgrid-footer").prepend(f.uiPaginationLabel)}},h));return f},_uiThumbnail:function(){var f=this,h=f.options,e=f.uiThumbnail.offset(),g=f.element.offset(),d=f.element.height()-e.top+g.top;f.uiThumbnail.css("height",d).thumbnailsgrid(b.extend({texts:{loading:h.texts.loading},pageIndex:0,url:h.grid.urlJson,loading:function(k,i){var j=i.data.paging;f.pageIndex=j.pageIndex;k.proxy.options.data.context=h.selectedContexts||"";k.proxy.options.data.inspectors=f._jsonInspectors();k.proxy.options.data.offset=j.pageIndex*j.pageSize;k.proxy.options.data.limit=j.pageSize},loaded:function(j,i){if(j.data.totalRows===0){f.uiPaginationLabel.html(h.texts.showNoItem);f.uiNbResult.html(h.texts.showNoItem)}else{f.uiPaginationLabel.html(b.nosI18nPlural(h.texts.showNbItems,j.data.length).replace("{{x}}",j.data.length).replace("{{y}}",j.data.totalRows));f.uiNbResult.html(b.nosI18nPlural(h.texts.NItems,j.data.totalRows).replace("{{count}}",j.data.totalRows))}f.uiNbResult.show();f.uiResetSearch[f.uiInspectorsTags.find(".nos-appdesk-inspectorstag").length||f.uiSearchInput.val()?"show":"hide"]()},rendered:function(){f.uiSplitterHorizontalBottom.find(".wijmo-wijpager").prepend(f.uiPaginationLabel);if(f.itemSelected!==null){var i=false;b.each(f.uiThumbnail.thumbnailsgrid("data")||[],function(j,k){if(k._model==f.itemSelected._model&&k._id==f.itemSelected._id){i=true;if(!f.uiThumbnail.thumbnailsgrid("select",j)){f.itemSelected=null}}});if(!i){f.uiThumbnail.thumbnailsgrid("unselect")}}},reader:{read:function(j){var i=parseInt(j.data.total,10);j.data=j.data.items;j.data.totalRows=i}},pageIndexChanging:function(){f.itemSelected=null;f.element.trigger("selectionChanged.appdesk",false)},selectionChanged:function(j,i){if(!i||b.isEmptyObject(i)){f.itemSelected=null;f.element.trigger("selectionChanged.appdesk",false)}else{f.itemSelected=b.extend({},i.item.data.noParseData);f.element.trigger("selectionChanged.appdesk",i.item.data.noParseData)}}},h.thumbnails));return f},_columnsMultiContext:function(e){var d=this,f=d.options;if(!f.hideContexts){b.each(e,function(g,h){if(h.dataKey==="context"){h.visible=f.selectedContexts.length>1}else{if(h.multiContextHide){h.visible=f.selectedContexts.length===1}}})}return d},_jsonInspectors:function(){var d=this,e=b.extend({},this.options.values||{});d.uiInspectorsTags.find("input").add(d.uiSearchInput).each(function(){var g=b(this),h=g.attr("name"),f=false;if(h.substr(-2,2)==="[]"){h=h.substr(0,h.length-2);f=true}if(!f){e[h]=g.val()}else{if(!b.isArray(e[h])){e[h]=[];e[h].push(g.val())}else{if(-1==b.inArray(g.val(),e[h])){e[h].push(g.val())}}}});return e},_resizeInspectorsV:function(e){var d=this;if(d.resizing){var f=d.uiInspectorsVertical.find(".wijmo-wijsplitter-v-bar").css({width:null,borderRightWidth:null}).end().find("> li").css({width:"100%",height:"auto"});if(f.length){f.css("height",(d.uiInspectorsVertical.height()/f.length)+"px").trigger(e?"widgetReload":"widgetResize")}else{d._hideSplitterV()}}return d},_resizeInspectorsH:function(e){var d=this;if(d.resizing){var f=d.uiInspectorsHorizontal.find(".wijmo-wijsplitter-h-bar").css({height:null,borderTopWidth:null}).end().find("> li").css({width:"auto",height:"100%"});if(f.length){f.css("width",(d.uiInspectorsHorizontal.width()/f.length)+"px").trigger(e?"widgetReload":"widgetResize")}else{d._hideSplitterH()}}d.uiSplitterVertical.wijsplitter("option","splitterDistance");d._trigger("slidersChange",null,d.slidersSettings());return d},_resizeList:function(f){var e=this,h=e.options;if(e.init){var d=e.uiSplitterHorizontalBottom.height()-e.uiSearchBar.outerHeight(true);if(h.defaultView==="thumbnails"){if(f){e._uiList()}else{e.uiThumbnail.thumbnailsgrid("setSize",e.uiSplitterHorizontalBottom.width(),d)}}else{if(h.defaultView==="treeGrid"){if(f){e._uiList()}else{e.uiTreeGrid.nostreegrid("setSize",null,d)}}else{e.uiGrid.noslistgrid("setSize",null,d);if(f){var g=b.grid.getHeights();e.uiGrid.noslistgrid("option","pageSize",Math.floor((d-g.footer-g.header-(e.showFilter?g.filter:0))/g.row))}}}}return e},_hideSplitterV:function(){var d=this;d.uiSplitterVertical.find(".wijmo-wijsplitter-v-bar").css({width:"0px",borderRightWidth:"0px"}).end().wijsplitter("option","panel1",{collapsed:true}).wijsplitter("refresh",true,false);return d},_hideSplitterH:function(){var d=this;d.uiSplitterHorizontal.find(".wijmo-wijsplitter-h-bar").css({height:"0px",borderTopWidth:"0px"}).end().wijsplitter("option","panel1",{collapsed:true}).wijsplitter("refresh",true,false);return d},gridReload:function(){var d=this,e=d.options;if(d.init){if(e.defaultView==="thumbnails"){d._uiList()}else{if(e.defaultView==="treeGrid"){d._uiList()}else{d.uiGrid.noslistgrid("option","pageIndex",d.pageIndex).noslistgrid("ensureControl",true)}}}return d},resize:function(){var d=this,e=d.options;d.uiSplitterVertical.wijsplitter("refresh",true,false);d.uiSplitterHorizontal.wijsplitter("refresh",true,false);d._resizeInspectorsV()._resizeInspectorsH()._resizeList();return d},slidersSettings:function(){return{vertical:{splitterDistance:this.uiSplitterVertical.wijsplitter("option","splitterDistance")/b(window).width()},horizontal:{splitterDistance:this.uiSplitterHorizontal.wijsplitter("option","splitterDistance")/b(window).height()}}}});b.extend({appdeskAdd:function(k,g){var f=this,j=false,e="",d,h=function(q){var l=b.extend({},true,q);var r=q.i18n||{};var o={},n=function(u,t){u.setupkey=t;return u},m=function(u,w){if(u[w+"Order"]){var x=u[w+"Order"].split(",");var t=[];for(var v=0;v<x.length;v++){if(u[w][x[v]]!=null){u[w][x[v]]["setupkey"]=x[v];t.push(u[w][x[v]])}}return t}else{return b.map(u[w],n)}},s={parseDOM:function(v,u,w,t){return this.parse(v.innerHTML,u,w,t)},parse:function(v,u,w,t){if(v===null){return t}return(v+"").replace(/&lt;/g,"<")},toStr:function(v,u,w,t){if(v===null){return t}return(v+"").replace(/</g,"&lt;")}},p=function(t){b.each(t,function(w,A){if(w==="i18nMessages"||w==="texts"){return}var v,y,z=[];if(b.isPlainObject(A)){if(b.isFunction(A._)){t[w]=A._()}else{p(A)}}else{if(b.isArray(A)){p(A)}}if(w==="columns"){t[w]=m(t,w);for(v=0;v<t[w].length;v++){if(t[w][v].context){if(l.hideContexts){t[w].splice(v,1);v--;continue}y=b.nosContext({locales:q.locales,sites:q.sites,contexts:q.contexts});t[w][v]={headerText:y.label({oneLocale:r.sites,oneSite:r.languages,defaultLabel:r.contexts||"Contexts"}),dataKey:"context",setupkey:"context",allowSort:false,showFilter:false,cellFormatter:function(B){if(B.row.type&b.wijmo.wijgrid.rowType.data){B.$container.css("text-align","center").html(B.row.data.context);return true}},width:1}}else{if(t[w][v].actions){z=t[w][v].actions;var x;var u=t[w][v].showOnlyArrow?true:false;if(u){x=20}else{x=b.grid.getActionWidth(z);if(z.length>1){}}t[w][v]={headerText:u?"":"",cellFormatter:function(B){var C;if(b.isPlainObject(B.row.data)){C=b.appdeskActions(z,B.row.data,{showOnlyArrow:u});C.appendTo(B.$container);B.$container.parent().addClass("buttontd").css({width:x+1});return true}},allowSizing:false,allowSort:false,width:x,ensurePxWidth:true,showFilter:false,setupkey:"actions"}}else{if(t[w][v].cellFormatters){(function(){var C=b.isPlainObject(t[w][v].cellFormatters)?t[w][v].cellFormatters:[t[w][v].cellFormatter];var B=t[w][v].cellFormatter;t[w][v]=b.extend(t[w][v],{cellFormatter:function(D){if(D.row.type&b.wijmo.wijgrid.rowType.data){D.$container.html(D.formattedValue);if(b.isFunction(B)){B.call(this,D)}b.each(C,function(G,F){F=b.nosDataReplace(b.extend(true,{},F),D.row.data);F=b.type(F)==="object"?F:{type:F};if(F.ignore&&parseInt(F.ignore)>0){return}if(F.replace){D.$container.empty()}switch(F.type){case"bold":D.$container.css("font-weight","bold");break;case"css":if(b.type(F.css)==="object"){D.$container.css(F.css)}break;case"icon":if(b.isPlainObject(D.row.data)){var H="";F.column&&D.row.data[F.column]&&(H=D.row.data[F.column]);F.src&&(H=F.src);b.type(F.mapping)==="object"&&F.mapping[D.formattedValue]&&(H=F.mapping[D.formattedValue]);if(!H){break}var E=(F.size?' width="'+F.size+'" height="'+F.size+'"':"");D.$container.prepend(' <img src="'+H+'" '+E+' style="vertical-align: middle;" /> ')}break;case"iconClasses":if(b.isPlainObject(D.row.data)){if(F.column&&!D.row.data[F.column]){break}D.$container.prepend(' <span class="'+(F.column?D.row.data[F.column]:F.classes)+'" style="float:left;"></span> ')}break;case"link":if(F.action==="default"&&z.length&&z[0].action){F.action=z[0].name}if(F.action&&b.type(F.action)!=="object"&&d.actions&&d.actions[F.action]){F._action_name=F.action;F.action=d.actions[F.action].action}if(F._action_name&&D.row.data.actions&&b.type(D.row.data.actions[F._action_name])==="string"){break}if(b.type(F.action)==="object"){D.$container.wrapInner(b('<a href="#"></a>').click(function(I){I.preventDefault();b(this).nosAction(F.action,D.row.data)}))}break;default:if(typeof F.type!=="undefined"){require([F.type],function(I){I.format(F,D)},function(){log("Could not load formatter: "+F.type)})}}});return true}}})})()}}}if(!t[w][v].dataParser&&!t[w][v].isSafeHtml&&!t[w][v].dataType){t[w][v].dataParser=s}}}})},o={tab:null,appdesk:{buttons:{},grid:{urlJson:"",columns:{}},thumbnails:null,defaultView:"grid",inspectors:{},splittersVertical:null,splittersHorizontal:null},i18nMessages:{},i18n:function(u){var v={};var t=this;b.extend(v,{label:u,_:function(){return t.i18nMessages[v.label]||v.label}});return v},build:function(){var v=b.extend(true,{appdesk:{texts:this.i18nMessages,splitters:{},slidersChange:function(w,x){}}},this);if(v.appdesk.splittersVertical){v.appdesk.splitters.vertical={splitterDistance:v.appdesk.splittersVertical}}if(v.appdesk.splittersHorizontal){v.appdesk.splitters.horizontal={splitterDistance:v.appdesk.splittersHorizontal}}v.appdesk.buttons=b.map(v.appdesk.buttons,n);v.appdesk.inspectors=m(v.appdesk,"inspectors");if(v.actions){var t=v.actions;if(v.appdesk.grid.columns.actions&&v.appdesk.grid.columns.actions.actions){b.each(v.appdesk.grid.columns.actions.actions,function(w,x){if(b.type(x)=="string"){v.appdesk.grid.columns.actions.actions[w]=t[x]}})}if(v.appdesk.treeGrid&&v.appdesk.treeGrid.columns&&v.appdesk.treeGrid.columns.actions&&v.appdesk.treeGrid.columns.actions.actions){b.each(v.appdesk.treeGrid.columns.actions.actions,function(w,x){if(b.type(x)=="string"){v.appdesk.treeGrid.columns.actions.actions[w]=t[x]}})}if(v.appdesk.thumbnails&&v.appdesk.thumbnails.actions){b.each(v.appdesk.thumbnails.actions,function(w,x){if(b.type(x)=="string"){v.appdesk.thumbnails.actions[w]=t[x]}})}b.each(v.appdesk.inspectors,function(w,x){if(x.preview&&x.options.actions){b.each(x.options.actions,function(y,z){if(b.type(z)=="string"){x.options.actions[y]=t[z]}})}})}l=v.appdesk;p(v);for(var u=0;u<v.appdesk.inspectors.length;u++){if(v.appdesk.inspectors[u].preview){v.appdesk.inspectors[u].url=function(y){var w=y.data("inspector"),x=b("<div></div>").appendTo(y).preview(w.options).parent().on({widgetResize:function(){x.preview("resize")}}).end()}}}return v}};return o};if(g.selectedView=="custom"){if(g.custom){e=g.views[g.custom.from].json;j=true}else{g.selectedView="default"}}if(g.selectedView!="custom"){e=g.views[g.selectedView].json}d=h(g);b.extend(true,d.i18nMessages,g.i18n);if(b.isPlainObject(g.appdesk)){b.extend(true,d,g.appdesk)}var i=function(){var q=(typeof g.hideContexts!="undefined"?g.hideContexts:Object.keys(g.contexts).length<=1);b.extend(true,d.appdesk,{contexts:g.contexts,sites:g.sites,locales:g.locales,hideContexts:q,views:g.views,name:g.configuration_id,selectedView:g.selectedView,selectedContexts:g.selectedContexts});if(j){b.extend(true,d.appdesk,{fromView:g.custom.from},g.custom.appdesk)}var n,r=b("div#"+k),l=r.closest(".nos-dispatcher"),p=d.build();if(b.isPlainObject(p.tab)&&!b.isEmptyObject(p.tab)){try{b(r).nosTabs("update",p.tab)}catch(o){log("Could not update current tab. Maybe your config file should not try to update it.")}}r.removeAttr("id").appdesk(p.appdesk);l.on({resizePanel:function(){if(n){window.clearTimeout(n)}n=window.setTimeout(function(){r.appdesk("resize")},200)},showPanel:function(){r.appdesk("resize")}});if(p.reloadEvent){if(!b.isArray(p.reloadEvent)){p.reloadEvent=[p.reloadEvent]}var m=function(){var s=[];b.each(p.reloadEvent,function(t,u){if(b.type(u)==="string"){if(l.data("nosContext")){s.push({name:u,context:l.data("nosContext")})}else{s.push({name:u})}}else{s.push(u)}});l.nosListenEvent(s,function(){r.appdesk("gridReload")},"appdeskContext")};m();l.on("contextChange",function(){l.nosUnlistenEvent("appdeskContext");m()})}r.bind("reloadView",function(u,t){b.extend(g,t);var s=b('<div id="'+k+'"></div>');s.insertAfter(r);r.remove();f.appdeskAdd(k,g)})};if(e&&(!b.isArray(e)||e.length)){require(e,function(){for(var l=0;l<arguments.length;l++){b.extend(true,d,arguments[l](d))}i()})}else{i()}},appdeskActionsList:[],appdeskActions:function(j,i,g){g=g||{};var d=b("<table><tr></tr></table>").addClass("buttontd wijgridtd");var f=[];var e=[];if(!g.showOnlyArrow){b.each(j,function(){if(this.primary){f.push(this)}else{e.push(this)}});if(e.length==1&&(e[0].icon||e[0].iconClasses)){f.push(e[0])}b.each(f,function(l,n){var k=false;if(n.iconClasses){k=n.iconClasses}else{if(n.icon){k="ui-icon ui-icon-"+n.icon}}var m=b("<th></th>").css("white-space","nowrap").addClass("ui-state-default"+(n.red?" ui-state-error":"")).attr("title",n.label).html((k?'<span class="'+k+'"></span>':"")+(n.text||!k?"&nbsp;"+n.label+"&nbsp;":""));var o=(n.name&&i&&i.actions&&typeof i.actions[n.name]!=="undefined")?i.actions[n.name]:true;if(o!==true){m.addClass("ui-state-disabled").click(function(p){p.stopImmediatePropagation();p.preventDefault()});if(b.type(o)==="string"){m.attr("title",o)}}else{m.click(function(p){p.stopImmediatePropagation();p.preventDefault();m.nosAction(n.action,i)}).hover(function(){b(this).addClass("ui-state-hover")},function(){b(this).removeClass("ui-state-hover")})}if(k&&!n.text){m.css({width:20,textAlign:"center"}).children().css({margin:"auto"})}else{if(k&&n.text){m.find("span").css("float","left")}}m.appendTo(d.find("tr"))})}if(g.showOnlyArrow||e.length>=2||(e.length==1&&!(e[0].icon||e[0].iconClasses))){var h=b("<th></th>").addClass("ui-state-default").css({width:"20px"}).hover(function(){b(this).addClass("ui-state-hover")},function(){b(this).removeClass("ui-state-hover")});b("<span></span>").addClass("ui-icon ui-icon-triangle-1-s").appendTo(h);h.appendTo(d.find("tr")).click(function(m){b.each(b.appdeskActionsList,function(){if(b(this).data("wijmo-wijmenu")){b(this).wijmenu("hideAllMenus")}});if(!this.created){var l=b("<ul></ul>");b.each(j,function(p,q){var o;if(q.iconClasses){o=q.iconClasses}else{if(q.icon){o="ui-icon ui-icon-"+q.icon}}var s='<span class="'+(o?o:"nos-icon16 nos-icon16-empty")+' wijmo-wijmenu-icon-left"></span><span class="wijmo-wijmenu-text">'+q.label+"</span>";var n=b('<li><a href="#"></a></li>').appendTo(l).find("a").html(s);if(q.red){n.addClass("ui-state-error")}var r=(q.name&&i&&i.actions&&typeof i.actions[q.name]!=="undefined")?i.actions[q.name]:true;if(r!==true){n.addClass("ui-state-disabled").click(function(t){t.stopImmediatePropagation();t.preventDefault()});if(b.type(r)==="string"){n.attr("title",r)}}else{n.click(function(t){t.stopImmediatePropagation();t.preventDefault();if(l.data("wijmo-wijmenu")){l.wijmenu("hideAllMenus")}n.nosAction(q.action,i)})}});var k=h.closest(".ui-dialog-content, .nos-dispatcher, body");l.appendTo(k);l.wijmenu({trigger:h,triggerEvent:"click",orientation:"vertical",animation:{animated:"slide",option:{direction:"up"},duration:50,easing:null},hideAnimation:{animated:"slide",option:{direction:"up"},duration:0,easing:null},position:{my:"right top",at:"right bottom",collision:"flip",offset:"0 0"}});b.appdeskActionsList.push(l);this.created=true;h.triggerHandler("click")}});h.click(false)}return d},grid:{getHeights:function(){if(this.heights===c){var d=b("<div></div>").appendTo("body");var e=b("<table></table>").addClass("nos-appdesk").appendTo(d).noslistgrid({scrollMode:"auto",pageSize:1,showFilter:true,allowPaging:true,data:[["test"],["test2"]]});this.heights={row:e.find("tr:first").height(),footer:d.find(".wijmo-wijgrid-footer").outerHeight(),header:d.find(".wijmo-wijgrid-headerrow").outerHeight(),filter:d.find(".wijmo-wijgrid-filterrow").outerHeight()};e.noslistgrid("destroy");d.remove()}return this.heights},getActionWidth:function(g){var d=b("<div></div>").appendTo("body");var f=b("<table></table>").addClass("nos-appdesk").appendTo(d).noslistgrid({scrollMode:"none",showFilter:true,allowPaging:true,columns:[{headerText:"",cellFormatter:function(h){if(b.isPlainObject(h.row.data)){var i=b.appdeskActions(g,[]);i.appendTo(h.$container);h.$container.parent().addClass("buttontd");return true}},allowSizing:true,showFilter:false,ensurePxWidth:true}],data:[{key:"value"}]});d.find("table.buttontd.wijgridtd").css({"font-size":"1.05em",width:"auto"});var e=d.find(".buttontd .buttontd:first").outerWidth();f.noslistgrid("destroy");d.remove();return e}}});return b});
define("jquery-nos-datacatchers",["jquery","jquery-nos","jquery-ui.widget","jquery-ui.button","wijmo.wijaccordion"],function(a){var b=void (0);a.widget("nos.datacatchers",{options:{model_id:"",model_name:""},_create:function(){var c=this,d=c.options;c.element.addClass("nos-datacatchers ui-widget-content");c.uiApplications=c.element.find(".catchers div");c.uiCatcherForm=c.element.find(".nos-datacatchers-catecherform");c.uiForm=c.element.find("form");c.uiSave=c.uiForm.find(".nos-datacatchers-buttons button");c.uiClose=c.element.find(".nos-datacatchers-close")},_init:function(){var c=this,d=c.options;c.element.find(".accordion").wijaccordion();c._applications();c.uiForm.nosFormUI();c._form(c.uiForm);c.uiForm.bind("ajax_success",function(g,f){c.uiApplications.html(f.applications);c._applications();c.uiCatcherForm.empty()});c.uiClose.click(function(f){f.preventDefault();c.element.trigger("close")});c.element.nosListenEvent({name:d.model_name,id:d.model_id,action:"update"},function(){a.ajax({url:"admin/nos/datacatcher/form",data:{model_name:d.model_name,model_id:d.model_id},success:function(e){c.element.nosAjaxSuccess(e);c.element.remove()}})})},_applications:function(){var c=this,d=c.options;c.uiApplications.find("button.catcher").each(function(){var e=a(this),g=e.data("params"),f=e.data("nuggets");e.button({label:g.title,icons:{primary:g.iconClasses||"nos-icon16 nos-icon16-share"}}).click(function(h){h.preventDefault();h.stopImmediatePropagation();if(g.action){a(this).nosAction(g.action,f)}else{a.ajax({url:g.url,success:function(i){c.uiCatcherForm.empty();a("<div><h3></h3><div></div></div>").appendTo(c.uiCatcherForm).find("h3").html(g.title).end().find("div").html(i).end().wijaccordion().nosFormUI();c._form(c.uiCatcherForm);c.uiCatcherForm.find(".nos-datacatchers-buttons a").click(function(j){j.preventDefault();c.uiCatcherForm.empty()})}})}});if(g.iconUrl){e.find(".ui-button-icon-primary").removeClass("nos-icon16-share").addClass("nos-icon16").css("background-image",'url("'+g.iconUrl+'")')}});return c},_form:function(e){var c=this,d=c.options;e.find(".nos-datacatchers-nugget-checkbox").each(function(){a(this).change(function(){if(a(this).is(":checked")){a(this).closest("tr").find("td:eq(0) .ui-widget").each(function(){var f=a(this).attr("disabled",true).data()})}else{a(this).closest("tr").find("td:eq(0) .ui-widget").each(function(){var f=a(this).removeAttr("disabled").data()})}}).triggerHandler("change")});e.find(".nos-datacatchers-nugget-image").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).click(function(){a(this).find("input").prop("checked",true);a(this).addClass("ui-state-active").siblings().removeClass("ui-state-active")});return c}});return a});
