...
define("jquery-nos-wysiwyg",["module","jquery-nos","jquery","tinymce"],function(a,b){b.fn.wysiwyg=function(d){var c=b(this);d=d||{};b.ajax({dataType:"json",url:"admin/nos/wysiwyg/enhancers",data:d.urlEnhancers?{urlEnhancers:true}:null,success:function(e){d=b.extend({script_url:"/static/novius-os/admin/vendor/tinymce/tiny_mce_jquery"+(a.config().minified?"":"_src")+".js",theme:"nos",plugins:"spellchecker,xhtmlxtras,style,table,advlist,inlinepopups,media,searchreplace,paste,noneditable,visualchars,nonbreaking",paste_text_use_dialog:true,theme_nos_enhancers:e,extended_valid_elements:"div[id|data-enhancer|data-config|class|style|title|dir<ltr?rtl|lang|xml::lang|onclick|ondblclick|onmousedown|onmouseup|onmouseover|onmousemove|onmouseout|onkeypress|onkeydown|onkeyup],img[longdesc|data-media-id|usemap|src|border|style|alt=|title|hspace|vspace|width|height|align]"},d||{});b(c).tinymce(d)}})};return b});
