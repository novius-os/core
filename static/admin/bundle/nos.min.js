...
define("jquery-nos-wysiwyg",["module","jquery-nos","jquery","tinymce"],function(a,b){b.fn.wysiwyg=function(d){var c=b(this);d=b.extend({urlEnhancers:null,container:null},d||{});b.ajax({dataType:"json",url:"admin/nos/wysiwyg/enhancers",data:{urlEnhancers:d.urlEnhancers,container:d.container},success:function(e){var f=b("base").attr("href");d=b.extend({document_base_url:f,language:b.nosLang.substr(0,2),script_url:f+"static/novius-os/admin/vendor/tinymce/tiny_mce_jquery"+(a.config().minified?"":"_src")+".js",doctype:'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">',theme:"nos",skin:"bootstrap",plugins:"spellchecker,xhtmlxtras,style,table,advlist,inlinepopups,media,searchreplace,paste,noneditable,visualchars,nonbreaking",paste_text_use_dialog:true,theme_nos_enhancers:e},d||{});b(c).tinymce(d)}})};return b});
