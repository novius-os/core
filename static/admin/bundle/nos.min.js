...
define("jquery-nos-wysiwyg",["jquery-nos","jquery","tinymce"],function(c,a){var b=1;c.fn.wysiwyg=function(e){var d=a(this);e=e||{};a.ajax({dataType:"json",url:"admin/nos/wysiwyg/enhancers",data:e.urlEnhancers?{urlEnhancers:true}:null,success:function(f){e=a.extend({script_url:"/static/novius-os/admin/vendor/tinymce/tiny_mce"+(assets_minified?"":"_src")+".js",theme:"nos",plugins:"spellchecker,xhtmlxtras,style,table,advlist,inlinepopups,media,searchreplace,paste,noneditable,visualchars,nonbreaking",theme_nos_enhancers:f},e||{});a(d).tinymce(e)}})};return c});
